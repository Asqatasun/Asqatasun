 ...
 * @author jkowalczyk
 */
public class WebResourceStatisticsDataServiceImpl extends AbstractGenericDataService<WebResourceStatistics, Long>
        implements WebResourceStatisticsDataService {
    ...
    public Long getNumberOfOccurrencesByWebResourceAndResultType(
            ...
            TestSolution testSolution) {
        return ((WebResourceStatisticsDAO) entityDao).
                findNumberOfOccurrencesByWebResourceAndResultType(webresourceId, testSolution);
    }
