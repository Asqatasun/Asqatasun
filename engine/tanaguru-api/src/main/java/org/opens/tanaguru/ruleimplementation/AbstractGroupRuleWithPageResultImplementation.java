 ...
 * @author jkowalczyk
 */
public abstract class AbstractGroupRuleWithPageResultImplementation extends AbstractRuleImplementation {
     ...
     */
    protected List<DefiniteResult> consolidateGroup(Site group,
    ...
    protected abstract List<DefiniteResult> consolidateGroupImpl(Site group,
            List<ProcessResult> groupedGrossResultSet,
            ProcessRemarkService processRemarkService);
     ...
     * {@link #consolidateGroup(org.opens.tanaguru.entity.subject.Site, java.util.Set)}
