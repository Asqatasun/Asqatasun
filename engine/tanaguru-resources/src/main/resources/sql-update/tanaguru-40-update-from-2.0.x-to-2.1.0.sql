...
ALTER TABLE WEB_RESOURCE_STATISTICS ADD `Weighted_Failed` numeric(7,1) UNSIGNED DEFAULT NULL AFTER Weighted_Passed;
ALTER TABLE WEB_RESOURCE_STATISTICS ADD `Weighted_Nmi` numeric(7,1) UNSIGNED DEFAULT NULL AFTER Weighted_Failed;
ALTER TABLE WEB_RESOURCE_STATISTICS ADD `Weighted_Na` numeric(7,1) UNSIGNED DEFAULT NULL AFTER Weighted_Nmi;
