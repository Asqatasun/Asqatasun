...
ALTER TABLE WEB_RESOURCE_STATISTICS ADD `Nb_Suspected` int(11) 0 NULL AFTER Nb_Na;
ALTER TABLE WEB_RESOURCE_STATISTICS ADD `Nb_Detected` int(11) 0 NULL AFTER Nb_Suspected;
ALTER TABLE WEB_RESOURCE_STATISTICS ADD `Nb_Not_Tested` int(11) 0 NULL AFTER Nb_Detected;
