...
CREATE TABLE IF NOT EXISTS `WEB_RESOURCE_STATISTICS` (
  ...
  `Weighted_Passed` numeric(7,1) UNSIGNED DEFAULT NULL,
  `Weighted_Failed` numeric(7,1) UNSIGNED DEFAULT NULL,
  `Weighted_Nmi` numeric(7,1) UNSIGNED DEFAULT NULL,
  `Weighted_Na` numeric(7,1) UNSIGNED DEFAULT NULL,
