...
public class TgStepTypeFactory extends StepTypeFactory{
    ...
    private static String PRIMARY_PACKAGE_FOR_STEP = "org.opens.tanaguru.sebuilder.interpreter.steptype.";
    private static String SECONDARY_PACKAGE_FOR_STEP = "com.sebuilder.interpreter.steptype.";
