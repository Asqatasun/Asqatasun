...
--
ALTER TABLE `CONTENT`
  ADD CONSTRAINT `FK6382C059A8A177A1` FOREIGN KEY Id_Page_Index (`Id_Page`) REFERENCES `WEB_RESOURCE` (`Id_Web_Resource`),
  ADD CONSTRAINT `FK6382C059493EC9C2` FOREIGN KEY Id_Audit_Index (`Id_Audit`) REFERENCES `AUDIT` (`Id_Audit`);
...
ALTER TABLE `EVIDENCE_ELEMENT`
  ADD CONSTRAINT `FK698B98F425AD22C4` FOREIGN KEY PROCESS_REMARK_Id_Process_Remark_Index (`PROCESS_REMARK_Id_Process_Remark`) REFERENCES `PROCESS_REMARK` (`Id_Process_Remark`),
...
ALTER TABLE `PROCESS_REMARK`
  ADD CONSTRAINT `FK1C3EA37045A988AD` FOREIGN KEY Id_Process_Result_Index (`Id_Process_Result`) REFERENCES `PROCESS_RESULT` (`Id_Process_Result`);
...
ALTER TABLE `PROCESS_RESULT`
  ...
  ADD CONSTRAINT `FK1C41A80D2E48600` FOREIGN KEY Id_Web_Resource_Index (`Id_Web_Resource`) REFERENCES `WEB_RESOURCE` (`Id_Web_Resource`),
...
ALTER TABLE `WEB_RESOURCE`
  ADD CONSTRAINT `FKD9A970B92F70FF12` FOREIGN KEY Id_Web_Resource_Parent_Index (`Id_Web_Resource_Parent`) REFERENCES `WEB_RESOURCE` (`Id_Web_Resource`),
  ADD CONSTRAINT `FKD9A970B9493EC9C2` FOREIGN KEY Id_Audit_Index (`Id_Audit`) REFERENCES `AUDIT` (`Id_Audit`);
