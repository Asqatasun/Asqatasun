...
public class Rule1203cTest extends AbstractRuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        ruleImplementationClassName = "org.opens.tanaguru.rule.accessiweb.Rule1203c";
    }
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.PASSED, consolidate("AW11.Test.12.03.a-2Failed-01").getValue());
