...
This test consists in checking whether the textual alternative of each canvas image that convey information is relevant.
...
The page has no `<canvas>` with a textual alternative (**Set2** is empty)
...
- [TestCases files for rule 1.3.7](https://gitlab.com/asqatasun/Asqatasun/-/tree/master/rules/rules-rgaa4.0/src/test/resources/testcases/rgaa40/Rgaa40Rule010307/)
- [Unit test file for rule 1.3.7](https://gitlab.com/asqatasun/Asqatasun/-/blob/master/rules/rules-rgaa4.0/src/test/java/org/asqatasun/rules/rgaa40/Rgaa40Rule010307Test.java)
- [Class file for rule 1.3.7](https://gitlab.com/asqatasun/Asqatasun/-/blob/master/rules/rules-rgaa4.0/src/main/java/org/asqatasun/rules/rgaa40/Rgaa40Rule010307.java)
