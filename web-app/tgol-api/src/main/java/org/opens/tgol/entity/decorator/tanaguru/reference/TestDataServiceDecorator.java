...
/**
 * This interface decorates the TestDataService interface defined in
 * the tanaguru API and adds more primitives.
 *
 * @author jkowalczyk
 */
public interface TestDataServiceDecorator extends TestDataService {
     ...
     */
    List<Test> findAllTestByLevel(Level level);
