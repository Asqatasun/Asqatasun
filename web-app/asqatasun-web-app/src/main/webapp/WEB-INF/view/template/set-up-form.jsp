            ...
            <div id="audit-options">
                ...
                <fieldset>
                    ...
                    <div class="clearfix ${auditParameterErrorClass}">
                        <c:if test="${! tg:instanceOf(parameter.formField, 'org.asqatasun.webapp.ui.form.CheckboxFormField')}">
                        <label id="set-up-${i18nKey}" 
                               for="${i18nKey}">
                            <fmt:message key="${i18nKey}"/>
                        </label>
                        ...
                        <div class="set-up-value input">
                        <c:choose>
                            <c:when test="${tg:instanceOf(parameter.formField, 'org.asqatasun.webapp.ui.form.SelectFormField')}">
                                <form:select id="${i18nKey}" 
                            ...
                            <c:when test="${tg:instanceOf(parameter.formField, 'org.asqatasun.webapp.ui.form.CheckboxFormField')}">
                            ...
                            <c:otherwise>
                                ...
                                <span class="help-block">
                                <c:choose>
                                    <c:when test="${tg:instanceOf(parameter.formField, 'org.asqatasun.webapp.ui.form.NumericalFormField')}">
