...
<%@include file="/WEB-INF/view/template/template_variables.jspf" %>
    ...
    <c:set var="top5FailedThemeGraphJsUrl" scope="request">
        <c:url value="/public/js/synthesis/repartition-by-failed-theme-min.js?v${asqatasunVersion}"/>
    </c:set>
    <c:set var="top5FailedThemeGraphIEJsUrl" scope="request">
        <c:url value="/public/js/ie/synthesis/repartition-by-failed-theme-ie-min.js?v${asqatasunVersion}"/>
    </c:set>
                        ...
                        <table id="top5-failed-test-by-page" class="tg-table">
                            ...
                            <tr>
                                ...
                                <th id="urlListTop5FailedTestByPage" scope="col" class="tg-textual-column">
                                    <spring:message code="synthesisSite.urlListCsv"/></th>
                                <th id="nbOfPagesTop5FailedTestByPage" scope="col" class="tg-numerical-column">
                                    <spring:message code="synthesisSite.nbOfPages"/></th>
                            </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td headers="testTop5FailedTestByPage" class="tg-textual-column">
                                        ...
                                        <abbr title="${fn:escapeXml(abbrTitle)}"
                                              style="border-bottom: 1px dotted;cursor: help;" ${ruleLang}>
                                    ...
                                    <td headers="urlListTop5FailedTestByPage" class="tg-textual-column">
                                        <a href="<c:url value="/home/contract/page-list.html?audit=${param.audit}&amp;status=f2xx&amp;sortDirection=2&amp;test=${failedTestByPageInfo.testLabel}"/>">
                                            <fmt:message
                                                key="synthesisSite.getUrlListCsv"><fmt:param>${failedTestByPageInfo.testLabel}</fmt:param></fmt:message>
                                        </a>
                                    </td>
                    ...
                    <div class="span16 tg-table-container">
                        <table id="top5-failed-url-by-test" class="tg-table">
                            ...
                            <tr>
                                ...
                                <th id="nbOfInvalidOccurrenceTop5FailedUrlByTest" scope="col"
                                    class="tg-numerical-column">
                                    <spring:message code="synthesisSite.nbOfInvalidOccurrence"/>
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach var="failedPageInfo" items="${failedPageInfoByTestSet}"
                                       varStatus="pFailedPageInfoByTestSet">
                                <tr>
                                    <td headers="pageUrlTop5FailedUrlByTest" class="tg-textual-column">
                                    <span class="open-external-url-icon">
                                        <a rel="noreferrer noopener" href="${failedPageInfo.webResourceUrl}"
                                           title="<fmt:message key="pageList.goTo"/> ${failedPageInfo.webResourceUrl}">
                                            <img src="${goToImgUrl}"
                                                 alt="<fmt:message key="pageList.goTo"/> ${failedPageInfo.webResourceUrl}">
                                        </a>
                                    </span>
                                        <a href="<c:url value="/home/contract/page-result.html?wr=${failedPageInfo.webResourceId}"/>"
                                           title="<fmt:message key="pageList.pageDetailedResult"></fmt:message> <fmt:message key="pageList.for"></fmt:message> ${failedPageInfo.webResourceUrl}">
                    ...
                    <div class="span16 tg-table-container">
                        <table id="top5-failed-url-by-occurrence" class="tg-table">
                            ...
                            <tr>
                                ...
                                <th id="nbOfInvalidOccurrenceTop5FailedUrlByOccurrence" scope="col"
                                    class="tg-numerical-column">
                                    <spring:message code="synthesisSite.nbOfInvalidOccurrence"/>
                                </th>
                                <th id="nbOfInvalidTestTop5FailedUrlByOccurrence" scope="col"
                                    class="tg-numerical-column">
                                    <spring:message code="synthesisSite.nbOfInvalidTest"/>
                                </th>
                            </tr>
                            ...
                            <tbody>
                            <c:forEach var="failedPageInfo" items="${failedPageInfoByOccurrenceSet}"
                                       varStatus="pFailedPageInfoByOccurrenceSet">
                                <tr>
                                    ...
                                    <td headers="nbOfInvalidOccurrenceTop5FailedUrlByOccurrence"
                                        class="tg-numerical-column">
                                            ${failedPageInfo.failedOccurrenceCounter}
                                    </td>
