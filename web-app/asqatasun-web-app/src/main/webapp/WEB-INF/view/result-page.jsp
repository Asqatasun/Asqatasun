...
<c:set var="detailResultManualJsUrl">
    <c:url value="/public/${asqatasunVersion}/js/result-page/detail-result-manual-min.js"/>
</c:set>
<c:set var="applyAutoResultsJsUrl">
    <c:url value="/public/${asqatasunVersion}/js/result-page/apply-auto-results-min.js"/>
</c:set>
