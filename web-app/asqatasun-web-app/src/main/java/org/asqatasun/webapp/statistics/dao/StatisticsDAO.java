...
import org.asqatasun.webapp.dto.factory.FailedPageInfoFactory;
import org.asqatasun.webapp.dto.factory.FailedTestInfoFactory;
import org.asqatasun.webapp.dto.factory.FailedThemeInfoFactory;
import org.asqatasun.webapp.dto.factory.PageResultFactory;
...
public class StatisticsDAO {
    ...
    private final FailedThemeInfoFactory failedThemeInfoFactory;
    private final FailedTestInfoFactory failedTestInfoFactory;
    private final FailedPageInfoFactory failedPageInfoFactory;
    private final PageResultFactory pageResultFactory;

    @Autowired
    public StatisticsDAO(FailedThemeInfoFactory failedThemeInfoFactory,
                         FailedTestInfoFactory failedTestInfoFactory,
                         FailedPageInfoFactory failedPageInfoFactory,
                         PageResultFactory pageResultFactory) {
        this.failedThemeInfoFactory = failedThemeInfoFactory;
        this.failedTestInfoFactory = failedTestInfoFactory;
        this.failedPageInfoFactory = failedPageInfoFactory;
    ...
    private Set<FailedThemeInfo> convertRawResultAsFailedThemeInfo(Collection<Object[]> result) {
        ...
        for (Object[] obj : result) {
            FailedThemeInfo fti = failedThemeInfoFactory.getFailedThemeInfo(
    ...
    private Set<FailedTestInfo> convertRawResultAsFailedTestInfo(Collection<Object[]> result) {
        ...
        for (Object[] obj : result) {
            if ((Integer)obj[2] > 0) {
                FailedTestInfo fti = failedTestInfoFactory.getFailedTestInfo(
                        (String)obj[0], 
                        (String)obj[1], 
    ...
    private Set<FailedPageInfo> convertRawResultAsFailedPageInfo(Collection<Object[]> result) {
        ...
        for (Object[] obj : result) {
            FailedPageInfo fti = failedPageInfoFactory.getFailedPageInfo(
                    (String)obj[0],
    ...
    private Set<PageResult> convertRawResultAsPageResultSet(Collection<Object[]> result) {
        ...
        for (Object[] obj : result) {
            ...
            PageResult fti = pageResultFactory.getPageResult(
                    (String)obj[0],
                    (Integer)obj[1], // rank
