...
import org.asqatasun.webapp.dto.RemarkInfos;
...
public class TestResultFactory {
    ...
    private final RemarkInfosFactory remarkInfosFactory;

    /**
     * Default private constructor
     */
    @Autowired
    public TestResultFactory(ProcessRemarkDataService processRemarkDataService,
                             AuditDataService auditDataService,
                             ProcessResultDataService processResultDataService,
                             TestDataService testDataService,
                             ResultCounterFactory resultCounterFactory,
                             RemarkInfosFactory remarkInfosFactory) {
        ...
        this.remarkInfosFactory = remarkInfosFactory;
    }
    ...
    private RemarkInfos getRemarkInfo(
        ...
        if (remarkTarget != null) {
            newRemarkInfo = remarkInfosFactory.getRemarksInfo(messageCode, remarkTarget);
        } else {
            newRemarkInfo = remarkInfosFactory.getRemarksInfo(messageCode);
        }
    ...
    private List<EvidenceElement> sortEvidenceElementSet(Collection<EvidenceElement> eeSet) {
        ...
        evidenceElementList.sort((o1, o2) -> {
    ...
    private Map<String, String> sortEvidenceElementMap(
        ...
        for (String testEvidenceRepresentationOrder : testResult.getTestEvidenceRepresentationOrder()) {
            ...
            if (evidenceElementMap.containsKey(tmpKey)) {
                ...
                LOGGER.info("The key " + testEvidenceRepresentationOrder + " is expected for the representation but not present in the" + " result evidence elements");
