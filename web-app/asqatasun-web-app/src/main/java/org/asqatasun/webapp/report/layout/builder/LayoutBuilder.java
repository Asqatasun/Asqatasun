...
public class LayoutBuilder {
    ...
    public void setMargin(String margin) {
        ...
        if (margins[TOP_MARGIN_INDEX] != null) {
            topMargin = Integer.parseInt(margins[TOP_MARGIN_INDEX]);
        }
        if (margins[BOTTOM_MARGIN_INDEX] != null) {
            bottomMargin = Integer.parseInt(margins[BOTTOM_MARGIN_INDEX]);
        }
        if (margins[LEFT_MARGIN_INDEX] != null) {
            leftMargin = Integer.parseInt(margins[LEFT_MARGIN_INDEX]);
        }
        if (margins[RIGHT_MARGIN_INDEX] != null) {
            rightMargin = Integer.parseInt(margins[RIGHT_MARGIN_INDEX]);
        }
    }
