...
public final class TgolPaginatedListFactory {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(TgolPaginatedListFactory.class);
     ...
     */
    private TgolPaginatedListFactory(StatisticsDataService statisticsDataService){
    ...
    private void setPageNumber(
        ...
        try {
            ...
            if (pageNumber != null && Integer.parseInt(pageNumber) >0 &&
                    Integer.parseInt(pageNumber) <= totalNumberOfPages) {
                paginatedList.setPageNumber(Integer.parseInt(pageNumber));
            } else {
