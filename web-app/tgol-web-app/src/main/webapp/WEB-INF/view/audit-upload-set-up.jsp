...
<html xmlns="http://www.w3.org/1999/xhtml" lang="${pageContext.response.locale}">
    <c:set var="pageTitle" scope="page">
        <spring:message code="auditSetUpUpload.pageTitle"/>
        <spring:hasBindErrors name="auditSetUpCommand">
            <spring:message code="auditSetUp.errorPageTitle"/>
        </spring:hasBindErrors>
    </c:set>
    <!-- import jquery uniform lib due to the file:input look & feel cross browser-->
    <%@include file="template/head.jsp" %>
    <body id="tgm-upload-page-set-up" class="tgm">
        <div id="meta-border">
            ...
            <div class="yui3-g">
                <div class="yui3-u-1">
                    ...
                    <h2 class="cmr cml"><spring:message code="auditSetUp.enterFile"/></h2>
                </div>
            </div>
            <div class="yui3-g">
                <div class="yui3-u-1">
