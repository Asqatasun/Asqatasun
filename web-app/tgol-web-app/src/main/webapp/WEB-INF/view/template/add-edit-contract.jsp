...
<div class="span16">
    <div id="mandatory-elements-message" 
...
<div class="span16">
    <div id="account-settings-form">
        <form:form method="post" 
                   modelAttribute="createContractCommand" 
                   acceptCharset="UTF-8" 
            ...
            <div class="clearfix ${userListErrorClass}">
                <label id="user-list-label" for="userList">
                    <fmt:message key="add-contract.users"/>
                </label>
                <div class="input" >
                <c:choose>
            ...
            <div class="clearfix ${labelErrorClass}">
                <label id="label-label" for="label">
                    <fmt:message key="edit-contract.contractLabel"/>
                </label>
                <div class="input" >
            ...
            <div class="clearfix ${beginDateErrorClass}">
                <label id="begin-date-label" 
                       for="beginDate">
                    <fmt:message key="edit-contract.contractBeginDate"/>
                </label>
                <div class="input" >
            ...
            <div class="clearfix ${endDateErrorClass}">
                <label id="end-date-label" 
                       for="endDate">
                    <fmt:message key="edit-contract.contractEndDate"/>
                </label>
                <div class="input" >
            ...
            <fieldset>
                <legend>
                    <fmt:message key="edit-contract.referentials"/>
                </legend>
                <div class="clearfix edit-contract-checkbox-block">
                <c:forEach items="${createContractCommand.referentialMap}" 
                           var="ref" 
                           varStatus="pRefInput">
                    ...
                    <c:set var="refKey">
                        ...
                        <label id="${refKey}" 
                               for="referentialMap${refKey}1" 
                               class="edit-contract-label">
                            <fmt:message key="${refKey}"/>
                        </label>
            ...
            <fieldset>
                <legend>
                    <fmt:message key="edit-contract.functionalities"/>
                </legend>
                <div class="clearfix edit-contract-checkbox-block">
            ...
            <fieldset>
                ...
                <div class="clearfix ${contractOptionErrorClass}">
                    ...
                    <div class="set-up-value input">
                        ...
                        <span class="help-block">
                        <c:choose>
                            <c:when test="${tg:instanceOf(option.formField, 'org.tanaguru.webapp.form.NumericalFormField')}">
