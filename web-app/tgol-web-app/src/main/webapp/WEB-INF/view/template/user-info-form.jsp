                ...
                <div class="span14 offset1">
                    <div id="account-settings-form">
                        <form:form method="post" modelAttribute="createUserCommand" acceptCharset="UTF-8" enctype="application/x-www-form-urlencoded">
                            ...
                            <div class="clearfix ">
                                <label id="account-settings-activated" for="activated1">${activated}</label>
                                <div class="input account-settings-field">
                                    <c:choose>
                                        <c:when test="${inhibActivateAndAdmin}">
                                    <form:checkbox path="activated" cssErrorClass="xlarge error" cssClass="xlarge uneditable-input" disabled="true" />
                                        </c:when>
                                        <c:otherwise>
                            ...
                            <div class="clearfix ">
                                <label id="account-settings-admin" for="admin1">${admin}</label>
                                <div class="input account-settings-field">
                                    <c:choose>
                                        <c:when test="${inhibActivateAndAdmin}">
                                    <form:checkbox path="admin" cssErrorClass="xlarge error" cssClass="xlarge uneditable-input" disabled="true"/>
                                        </c:when>
                                        <c:otherwise>
                            ...
                            <div id="change-password-link" class="actions">
                                <a class="btn large" href="<c:url value="${changePasswordUrl}"/>">
