...
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
            <div class="row">
                <div class="span14 offset1">
                    <form:form modelAttribute="contractSortCommand" method="post" acceptCharset="UTF-8" enctype="application/x-www-form-urlencoded" class="option-console">
                        ...
                        <div class="row">
                                ...
                                <fieldset>
                                    ...
                                    <div class="clearfix ${auditParameterErrorClass}">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <form:input id="${i18nKey}" path="sortOptionMap[${i18nKey}]" cssErrorClass="xlarge error" cssClass="xlarge"/>
                            ...
                            <c:if test="${homeActionList != null && not empty homeActionList}">
                            <div class="span6 offset1">
                                <fieldset>
                                    <legend><fmt:message key="result.export"/></legend>
                                    <div id="audit-result-menu-actions" class="clearfix">
                                        <c:forEach var="action" items="${homeActionList}" varStatus="pAction">
                                            <c:choose>
