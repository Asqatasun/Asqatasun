                            ...
                            <div class="span6 offset1">
                                <fieldset>
                                    ...
                                    <div id="audit-result-menu-actions" class="clearfix">
                                        ...
                                        <a href="<c:url value="${action.actionUrl}&amp;wr=${param.wr}"/>" class="btn disabled primary" title="${action.actionAltI81NCode}">
                                            <fmt:message key="${action.actionI81NCode}"/>
                                        </a>
                                                </c:when>
                                                <c:otherwise>
                                                <!-- the url actions already have a parameter (export type for example-->
                                        <a href="<c:url value="${action.actionUrl}&amp;wr=${param.wr}"/>" class="btn primary" title="${action.actionAltI81NCode}">
                                            <fmt:message key="${action.actionI81NCode}"/>
                                        </a>
                                                </c:otherwise>
                                            </c:choose>
