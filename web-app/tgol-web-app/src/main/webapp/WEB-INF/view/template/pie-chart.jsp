           ...
           <tr>
               ...
               <td colspan="2">
                   <span class="fd-slider-wrapper">
                       ...
                       <span class="fd-slider-range passed" 
                             style="left: ${passedLeftOffset}%; width: ${passedPercent}%;">
                       </span>
           ...
           <tr>
               ...
               <td colspan="2">
                   <span class="fd-slider-wrapper">
                       ...
                       <span class="fd-slider-range failed" 
                             style="left: ${failedLeftOffset}%; width: ${failedPercent}%;">
                       </span>
                       <span class="fd-slider-bar"></span>
                   </span>
               </td>
           ...
           <tr>
               ...
               <td colspan="2">
                   <span class="fd-slider-wrapper">
                       ...
                       <span class="fd-slider-range na" 
                             style="left: ${naLeftOffset}%; width: ${naPercent}%;">
                       </span>
                       <span class="fd-slider-bar"></span>
                   </span>
               </td>
           ...
           <tr>
               ...
               <td colspan="2">
                   <span class="fd-slider-wrapper">
                       ...
                       <span class="fd-slider-range nmi" 
                             style="left: ${nmiLeftOffset}%; width: ${nmiPercent}%;">
                       </span>
                       <span class="fd-slider-bar"></span>
                   </span>
               </td>
