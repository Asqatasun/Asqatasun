                    ...
                    <c:choose>
                        ...
                        <fieldset>
                            ...
                            <div class="clearfix ${urlListIndexErrorClass}">
                                <label id="label-url${pUrlIndex.index+1}" for="urlList${pUrlIndex.index}">
                                    <span class="mandatory">* </span>URL ${pUrlIndex.index+1}
                                </label>
                                <div class="url-input input">
                            ...
                            <div id="extra-inputs">
                                ...
                                <div id="extra-input${pUrlIndex.index+1}" class="clearfix ${urlListIndexErrorClass}">
                                    <label id="label-url${pUrlIndex.index+1}" for="urlList${pUrlIndex.index}">
                        ...
                        <fieldset>
                            ...
                            <div class="clearfix ${fileIndexErrorClass}">
                                <label id="label-url${pFileInput.index+1}" for="fileInputList${pFileInput.index}">
                                    <span class="mandatory">* </span><fmt:message key="auditSetUp.file"/> ${fileLabel}
                                </label>
                                <div class="file-input input">
                                    <form:input path="fileInputList[${pFileInput.index}]" cssErrorClass="input-file error xlarge" cssClass="input-file xlarge" title="${fileLabel}" type="file"/>
                            ...
                            <div id="extra-inputs">
                                ...
                                <div id="extra-input${pFileInput.index+1}" class="clearfix ${urlListIndexErrorClass}">
                                    <label id="label-url${pFileInput.index+1}" for="fileInputList${pFileInput.index}">
                                        ${fileLabel}
                                    </label>
                                    <div class="file-input input">
                        ...
                        <h2>
                            <span class="master-audit-options ${onError}"><fmt:message key="auditSetUp.formTitle"/></span>
                        </h2>
                        ...
                        <div id="audit-set-up-form-submit" class="actions">
                            <input id="launch-audit-submit" type="submit" value="<fmt:message key="auditSetUp.launchAudit"/>" class="large awesome orange xlarge"/>
                        </div>
