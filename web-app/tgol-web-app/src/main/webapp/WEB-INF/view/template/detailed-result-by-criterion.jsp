...
<%@taglib uri="http://tagutils" prefix="tg" %>
                ...
                <div id="theme${entry.key.rank}-details" class="theme-details">
                        <c:forEach var="criterionResult" items="${entry.value}" varStatus="pCriterionResultList">
                            <c:choose>
                            ...
                            <div class="row criterion-result-compact">
                                ...
                                <div class="span1 criterion-details">
                                    <a href="<c:url value="/home/contract/criterion-result.html?wr=${param.wr}&amp;crit=${criterionResult.criterion.id}"/>" class="criterion-result-compact" title="Voir le détail des tests du critère ${criterionResult.criterion.label}">
                                        <img src="<c:url value="/Images/criterion-detail.png"/>" alt="Voir le détail des tests du critère ${criterionResult.criterion.label}"/>
                                    </a>
                                </div><!-- class="span1 criterion-details" -->
                            </div><!-- class="row" -->
