...
<%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
                        ...
                        <div id="process-dialog">
                            <p class="process-message"><fmt:message key="auditSetUp.processMessage1"/></p>
                            <p class="process-message"><fmt:message key="auditSetUp.processMessage2"/></p>
                            <p class="process-message"><fmt:message key="auditSetUp.processMessage3"/></p>
                            <p class="process-message"><fmt:message key="auditSetUp.processMessage4"/></p>
                            <p class="process-message"><fmt:message key="auditSetUp.processMessage5"/></p>
                            <p class="process-message"><fmt:message key="auditSetUp.processMessage6"/></p>
                            <p class="process-message"><fmt:message key="auditSetUp.processMessage7"/></p>
                            <p class="process-message"><fmt:message key="auditSetUp.processMessage8"/></p>
                            <p class="process-message"><fmt:message key="auditSetUp.processMessage9"/></p>
