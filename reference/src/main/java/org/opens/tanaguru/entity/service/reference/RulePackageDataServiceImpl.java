 ...
 * @author ADEX
 */
public class RulePackageDataServiceImpl extends AbstractGenericDataService<RulePackage, Long> implements
        RulePackageDataService {

    public RulePackageDataServiceImpl() {
        super();
    }
}
