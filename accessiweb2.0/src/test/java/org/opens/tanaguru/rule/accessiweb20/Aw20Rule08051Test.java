...
public class Aw20Rule08051Test extends AbstractRuleImplementationTestCase {
    ...
    protected void setUpWebResourceMap() {
        webResourceMap.put("AW20.Test.08.05.01-1Passed-01",
                ...
                TESTCASES_FILES_PATH + "AW22/AW20.Test.08.05.01-1Passed-01.html"));
        webResourceMap.put("AW20.Test.08.05.01-2Failed-01",
                webResourceFactory.createPage(
                TESTCASES_FILES_PATH + "AW22/AW20.Test.08.05.01-2Failed-01.html"));
        webResourceMap.put("AW20.Test.08.05.01-2Failed-02",
                webResourceFactory.createPage(
                TESTCASES_FILES_PATH + "AW22/AW20.Test.08.05.01-2Failed-02.html"));
        webResourceMap.put("AW20.Test.08.05.01-2Failed-03",
                webResourceFactory.createPage(
                TESTCASES_FILES_PATH + "AW22/AW20.Test.08.05.01-2Failed-03.html"));
    }
