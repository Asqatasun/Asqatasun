...
public class SeoRule05011Test extends SeoRuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.seo.SeoRule05011");
    }
    ...
    protected void setProcess() {
        ProcessResult processResult =
                processPageTest("Seo.Test.5.1.1-2Failed-01");
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Seo.Test.5.1.1-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Seo.Test.5.1.1-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Seo.Test.5.1.1-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Seo.Test.5.1.1-4NA-04").getValue());
