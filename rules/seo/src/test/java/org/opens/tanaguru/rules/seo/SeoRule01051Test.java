 ...
 * @author jkowalczyk
 */
public class SeoRule01051Test extends SeoRuleImplementationTestCase {
    
    public SeoRule01051Test(String testName) {
        super(testName);
    }
    
    @Override
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.opens.tanaguru.rules.seo.SeoRule01051");
    }
