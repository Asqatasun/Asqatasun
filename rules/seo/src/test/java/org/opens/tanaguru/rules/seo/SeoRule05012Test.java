 ...
 * @author jkowalczyk
 */
public class SeoRule05012Test extends SeoRuleImplementationTestCase {

    public SeoRule05012Test(String testName) {
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.seo.SeoRule05012");
    }
    ...
    protected void setUpWebResourceMap() {
        ...
        getWebResourceMap().put("Seo.Test.5.1.2-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "SEO/SeoRule05012/Seo.Test.5.1.2-4NA-01.html"));
        getWebResourceMap().put("Seo.Test.5.1.2-4NA-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "SEO/SeoRule05012/Seo.Test.5.1.2-4NA-02.html"));
        getWebResourceMap().put("Seo.Test.5.1.2-4NA-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "SEO/SeoRule05012/Seo.Test.5.1.2-4NA-03.html"));
        getWebResourceMap().put("Seo.Test.5.1.2-4NA-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "SEO/SeoRule05012/Seo.Test.5.1.2-4NA-04.html"));
        getWebResourceMap().put("Seo.Test.5.1.2-4NA-05",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "SEO/SeoRule05012/Seo.Test.5.1.2-4NA-05.html"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Seo.Test.5.1.2-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Seo.Test.5.1.2-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Seo.Test.5.1.2-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Seo.Test.5.1.2-4NA-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Seo.Test.5.1.2-4NA-05").getValue());
