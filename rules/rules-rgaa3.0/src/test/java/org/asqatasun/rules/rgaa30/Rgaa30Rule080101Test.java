...
/**
 * Unit test class for the implementation of the rule 8.1.1 of the referential Rgaa 3.0.
 *
 * @author jkowalczyk
 */
public class Rgaa30Rule080101Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.asqatasun.rules.rgaa30.Rgaa30Rule080101");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa30.Test.08.01.01-1Passed-01");
        addWebResource("Rgaa30.Test.08.01.01-2Failed-01");
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
        WebResource webResource = webResourceMap.get("Rgaa30.Test.08.01.01-1Passed-01");
