...
public class Rgaa30Rule010608Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa30.Rgaa30Rule010608");
    }
    ...
    protected void setUpWebResourceMap() {
        ...
        addWebResource("Rgaa30.Test.1.6.8-3NMI-02");
        addWebResource("Rgaa30.Test.1.6.8-4NA-01");
        addWebResource("Rgaa30.Test.1.6.8-4NA-02");
        addWebResource("Rgaa30.Test.1.6.8-4NA-03");
        addWebResource("Rgaa30.Test.1.6.8-4NA-04",
                createParameter("Rules", DECORATIVE_IMAGE_MARKER, "decorative-image"));
        addWebResource("Rgaa30.Test.1.6.8-4NA-05");
    }
