...
public class Rgaa30Rule080901Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.asqatasun.rules.rgaa30.Rgaa30Rule080901");
    }
    ...
    protected void setUpWebResourceMap() {
        ...
        addWebResource("Rgaa30.Test.08.09.01-3NMI-08");
        addWebResource("Rgaa30.Test.08.09.01-3NMI-09");
    }
    ...
    protected void setProcess() {
        ...
        //---------------------------3NMI-08------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa30.Test.08.09.01-3NMI-08");
        checkResultIsPreQualified(processResult, 17, 1);
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
        ...
        //---------------------------3NMI-09------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa30.Test.08.09.01-3NMI-09");
        checkResultIsPreQualified(processResult, 17, 1);
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
