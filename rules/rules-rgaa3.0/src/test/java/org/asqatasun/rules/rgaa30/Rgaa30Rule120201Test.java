 ...
 * @author jkowalczyk
 */
public class Rgaa30Rule120201Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.asqatasun.rules.rgaa30.Rgaa30Rule120201");
    }
    ...
    protected void setUpWebResourceMap() {
        ...
        Page page = getWebResourceFactory().createPage(getTestcasesFilePath() +
                "rgaa30/Rgaa30Rule120201/Rgaa30.Test.12.02.01-3NMI-01.html");
        site.addChild(page);
        getWebResourceMap().put("Rgaa30.Test.12.02.01-5NT-01-page1",page);
    ...
    protected void setProcess() {
        ProcessResult pr = processPageTest("Rgaa30.Test.12.02.01-4NA-01");
        assertTrue(pr instanceof IndefiniteResult);
        assertEquals(getWebResourceMap().get("Rgaa30.Test.12.02.01-4NA-01"),pr.getSubject());
    ...
    protected void setConsolidate() {
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.12.02.01-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa30.Test.12.02.01-5NT-01").getValue());
    }
