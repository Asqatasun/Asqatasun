 ...
 *
 * For more details about the implementation, refer to <a href="http://doc.asqatasun.org/en/40_Rules/rgaa3.0/01.Images/Rule-1-7-6.html">the rule 1.7.6 design page.</a>
 * @see <a href="http://references.modernisation.gouv.fr/referentiel-technique-0#test-1-7-6"> 1.7.6 rule specification</a>
 */

public class Rgaa30Rule010706 extends AbstractMarkerPageRuleImplementation {
