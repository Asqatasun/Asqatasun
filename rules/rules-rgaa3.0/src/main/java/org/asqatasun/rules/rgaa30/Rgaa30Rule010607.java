 ...
 *
 * For more details about the implementation, refer to <a href="http://doc.asqatasun.org/en/90_Rules/rgaa3.0/01.Images/Rule-1-6-7.html">the rule 1.6.7 design page.</a>
 * @see <a href="http://references.modernisation.gouv.fr/referentiel-technique-0#test-1-6-7"> 1.6.7 rule specification</a>
 */

public class Rgaa30Rule010607 extends AbstractMarkerPageRuleImplementation {
