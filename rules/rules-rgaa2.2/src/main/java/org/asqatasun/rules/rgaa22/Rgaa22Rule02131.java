 ...
 * <br/>
 * For more details about the implementation, refer to <a href="http://www.old-dot-org.org/en/content/rgaa22-rule-2-13">the rule 2.13 design page.</a>
 * @see <a href="http://rgaa.net/Valeur-du-rapport-de-contraste-du,15.html"> 2.13 rule specification </a>
 *
 * @author jkowalczyk
 */
public class Rgaa22Rule02131 extends AbstractPageRuleWithCheckerImplementation {

    /** The constract checker with a value of ratio set to 3*/
    private static final ContrastChecker CONSTRAST_CHECKER = 
            new ContrastChecker(7f, true, true, true);

    /**
     * Default constructor
     */
    public Rgaa22Rule02131 () {
