...
import static org.asqatasun.rules.keystore.HtmlElementStore.DL_ELEMENT;
 ...
 * <br/>
 * For more details about the implementation, refer to <a href="http://www.old-dot-org.org/en/content/rgaa22-rule-10-7">the rule 10.7 design page.</a>
 * @see <a href="http://rgaa.net/Balisage-correct-des-listes-de.html"> 10.7 rule specification </a>
 *
 * @author jkowalczyk
 */
public class Rgaa22Rule10071 extends AbstractDetectionPageRuleImplementation {

    /** The element selector */
    private static final ElementSelector ELEMENT_SELECTOR = 
            new SimpleElementSelector(DL_ELEMENT);

    /**
     * Default constructor
     */
    public Rgaa22Rule10071 () {
        super(
                ELEMENT_SELECTOR,
