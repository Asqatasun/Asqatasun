 ...
 * <br/>
 * For more details about the implementation, refer to <a href="http://www.old-dot-org.org/en/content/rgaa22-rule-5-11">the rule 5.11 design page.</a>
 * @see <a href="http://rgaa.net/Presence-d-une-alternative-aux.html"> 5.11 rule specification </a>
 *
 * @author jkowalczyk
 */
public class Rgaa22Rule05111 extends AbstractDetectionPageRuleImplementation {

    /** The element selector */
    private static final ElementSelector ELEMENT_SELECTOR = 
            new MultipleElementSelector(APPLET_ELEMENT, OBJECT_ELEMENT);
    
    /**
     * Default constructor
     */
    public Rgaa22Rule05111 () {
        super(
                ELEMENT_SELECTOR,
