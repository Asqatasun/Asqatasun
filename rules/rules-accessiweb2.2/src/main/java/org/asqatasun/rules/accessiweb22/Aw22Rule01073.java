...
/**
 * Implementation of the rule 1.7.3 of the referential Accessiweb 2.2.
 * <br/>
 * For more details about the implementation, refer to <a href="http://doc.asqatasun.org/en/90_Rules/accessiweb2.2/01.Images/Rule-1.7.3.html">the rule 1.7.3 design page.</a>
 * @see <a href="http://www.accessiweb.org/index.php/accessiweb-22-english-version.html#test-1-7-3"> 1.7.3 rule specification</a>
 *
 */
public class Aw22Rule01073 extends AbstractMarkerPageRuleImplementation {

    /**
     * Default constructor
     */
    public Aw22Rule01073() {
        super(
