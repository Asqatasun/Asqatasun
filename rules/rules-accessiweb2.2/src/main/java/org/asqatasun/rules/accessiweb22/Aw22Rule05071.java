...
/**
 * Implementation of the rule 5.7.1 of the referential Accessiweb 2.2.
 * <br/>
 * For more details about the implementation, refer to <a href="http://doc.asqatasun.org/en/90_Rules/accessiweb2.2/05.Tables/Rule-5.7.1.html">the rule 5.7.1 design page.</a>
 * @see <a href="http://www.accessiweb.org/index.php/accessiweb-22-english-version.html#test-5-7-1"> 5.7.1 rule specification</a>
 *
 */
public class Aw22Rule05071 extends AbstractMarkerPageRuleImplementation {

    /**
     * Default constructor
     */
    public Aw22Rule05071() {
        super(
