...
/**
 * Unit test class for the implementation of the rule 12.2.1 of the referential Accessiweb 2.2.
 *
 * @author jkowalczyk
 */
public class Aw22Rule12021Test extends Aw22RuleImplementationTestCase {

    /**
     * Default constructor
     */
    public Aw22Rule12021Test (String testName){
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.accessiweb22.Aw22Rule12021");
    }
   ...
   @Override
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.12.2.1-4NA-01",
                ...
                getTestcasesFilePath() + "accessiweb22/Aw22Rule12021/AW22.Test.12.2.1-3NMI-01.html"));
        ...
        Page page = getWebResourceFactory().createPage(getTestcasesFilePath() +
                "accessiweb22/Aw22Rule12021/AW22.Test.12.2.1-3NMI-01.html");
        site.addChild(page);
    ...
    protected void setProcess() {
        ...
        assertEquals(getWebResourceMap().get("AW22.Test.12.2.1-4NA-01"),pr.getSubject());
