...
public class Aw22Rule13152Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.accessiweb22.Aw22Rule13152");
    }
...
//              getTestcasesFilePath() + "accessiweb22/Aw22Rule13152/AW22.Test.13.15.2-1Passed-01.html"));
//        getWebResourceMap().put("AW22.Test.13.15.2-2Failed-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "accessiweb22/Aw22Rule13152/AW22.Test.13.15.2-2Failed-01.html"));
        getWebResourceMap().put("AW22.Test.13.15.2-3NMI-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule13152/AW22.Test.13.15.2-3NMI-01.html"));
//        getWebResourceMap().put("AW22.Test.13.15.2-4NA-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "accessiweb22/Aw22Rule13152/AW22.Test.13.15.2-4NA-01.html"));
    }
