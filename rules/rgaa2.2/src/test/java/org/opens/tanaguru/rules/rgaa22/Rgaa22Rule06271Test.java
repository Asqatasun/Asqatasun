 ...
 * @author jkowalczyk
 */
public class Rgaa22Rule06271Test extends Rgaa22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.rgaa22.Rgaa22Rule06271");
    }

    @Override
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("RGAA22.Test.6.27-3NMI-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa22/Rgaa22Rule06271/RGAA22.Test.6.27-3NMI-01.html"));
        getWebResourceMap().put("RGAA22.Test.6.27-3NMI-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa22/Rgaa22Rule06271/RGAA22.Test.6.27-3NMI-02.html"));
        getWebResourceMap().put("RGAA22.Test.6.27-3NMI-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa22/Rgaa22Rule06271/RGAA22.Test.6.27-3NMI-03.html"));
        getWebResourceMap().put("RGAA22.Test.6.27-3NMI-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa22/Rgaa22Rule06271/RGAA22.Test.6.27-3NMI-04.html"));
        getWebResourceMap().put("RGAA22.Test.6.27-3NMI-05",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa22/Rgaa22Rule06271/RGAA22.Test.6.27-3NMI-05.html"));
        getWebResourceMap().put("RGAA22.Test.6.27-3NMI-06",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa22/Rgaa22Rule06271/RGAA22.Test.6.27-3NMI-06.html"));
        getWebResourceMap().put("RGAA22.Test.6.27-4NA-01",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "rgaa22/Rgaa22Rule06271/RGAA22.Test.6.27-4NA-01.html"));
        getWebResourceMap().put("RGAA22.Test.6.27-4NA-02",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "rgaa22/Rgaa22Rule06271/RGAA22.Test.6.27-4NA-02.html"));
        getWebResourceMap().put("RGAA22.Test.6.27-4NA-03",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "rgaa22/Rgaa22Rule06271/RGAA22.Test.6.27-4NA-03.html"));
    }
    ...
    protected void setConsolidate() {
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("RGAA22.Test.6.27-3NMI-01").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("RGAA22.Test.6.27-3NMI-02").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("RGAA22.Test.6.27-3NMI-03").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("RGAA22.Test.6.27-3NMI-04").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("RGAA22.Test.6.27-3NMI-05").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("RGAA22.Test.6.27-3NMI-06").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("RGAA22.Test.6.27-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("RGAA22.Test.6.27-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("RGAA22.Test.6.27-4NA-03").getValue());
    }
