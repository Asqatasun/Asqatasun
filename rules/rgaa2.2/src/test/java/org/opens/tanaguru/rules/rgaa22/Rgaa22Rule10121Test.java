...
public class Rgaa22Rule10121Test extends Rgaa22RuleImplementationTestCase {
    ...
    protected void setUpWebResourceMap() {
        ...
        getWebResourceMap().put("Rgaa22.Test.10.12-4NA-02",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "rgaa22/Rgaa22Rule10121/RGAA22.Test.10.12-4NA-02.html"));
    }
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa22.Test.10.12-4NA-02").getValue());
    }
