...
public class Rgaa22Rule06151Test extends Rgaa22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.rgaa22.Rgaa22Rule06151");
    }
...
//              getTestcasesFilePath() + "RGAA22/Rgaa22Rule06151/RGAA22.Test.6.15-4NA-01.html"));
        getWebResourceMap().put("Rgaa22.Test.6.15-5NT-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "RGAA22/Rgaa22Rule06151/RGAA22.Test.6.15-5NT-01.html"));
    }

    @Override
    protected void setProcess() {
//        assertEquals(TestSolution.PASSED,
//                processPageTest("Rgaa22.Test.6.15-1Passed-01").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("Rgaa22.Test.6.15-2Failed-01").getValue());
//        assertEquals(TestSolution.NEED_MORE_INFO,
//                processPageTest("Rgaa22.Test.6.15-3NMI-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("Rgaa22.Test.6.15-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                processPageTest("Rgaa22.Test.6.15-5NT-01").getValue());
    }
...
//                consolidate("Rgaa22.Test.6.15-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa22.Test.6.15-5NT-01").getValue());
    }
