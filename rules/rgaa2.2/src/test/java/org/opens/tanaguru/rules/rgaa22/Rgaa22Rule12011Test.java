...
//              getTestcasesFilePath() + "RGAA22/Rgaa22Rule12011/RGAA22.Test.12.1-4NA-01.html"));
        getWebResourceMap().put("Rgaa22.Test.12.1-5NT-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "RGAA22/Rgaa22Rule12011/RGAA22.Test.12.1-5NT-01.html"));
    }

    @Override
    protected void setProcess() {
//        assertEquals(TestSolution.PASSED,
//                processPageTest("Rgaa22.Test.12.1-1Passed-01").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("Rgaa22.Test.12.1-2Failed-01").getValue());
//        assertEquals(TestSolution.NEED_MORE_INFO,
//                processPageTest("Rgaa22.Test.12.1-3NMI-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("Rgaa22.Test.12.1-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                processPageTest("Rgaa22.Test.12.1-5NT-01").getValue());
    }
...
//                consolidate("Rgaa22.Test.12.1-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa22.Test.12.1-5NT-01").getValue());
    }
