...
/**
 * Unit test class for the implementation of the rule 9.8 of the referential RGAA 2.2.
 *
 * @author jkowalczyk
 */
public class Rgaa22Rule09081Test extends Rgaa22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.rgaa22.Rgaa22Rule09081");
    }
...
//        getWebResourceMap().put("Rgaa22.Test.9.8-4NA-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "RGAA22/Rgaa22Rule09081/RGAA22.Test.9.8-4NA-01.html"));
        getWebResourceMap().put("Rgaa22.Test.9.8-5NT-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "RGAA22/Rgaa22Rule09081/RGAA22.Test.9.8-5NT-01.html"));
    }

    @Override
    protected void setProcess() {
//        assertEquals(TestSolution.PASSED,
//                processPageTest("Rgaa22.Test.9.8-1Passed-01").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("Rgaa22.Test.9.8-2Failed-01").getValue());
//        assertEquals(TestSolution.NEED_MORE_INFO,
//                processPageTest("Rgaa22.Test.9.8-3NMI-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("Rgaa22.Test.9.8-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                processPageTest("Rgaa22.Test.9.8-5NT-01").getValue());
    }
...
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                consolidate("Rgaa22.Test.9.8-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa22.Test.9.8-5NT-01").getValue());
    }
