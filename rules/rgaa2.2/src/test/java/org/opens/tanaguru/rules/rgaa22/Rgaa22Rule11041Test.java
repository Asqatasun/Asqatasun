...
public class Rgaa22Rule11041Test extends Rgaa22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.rgaa22.Rgaa22Rule11041");
    }
...
//              getTestcasesFilePath() + "RGAA22/Rgaa22Rule11041/RGAA22.Test.11.4-4NA-01.html"));
        getWebResourceMap().put("Rgaa22.Test.11.4-5NT-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "RGAA22/Rgaa22Rule11041/RGAA22.Test.11.4-5NT-01.html"));
    }

    @Override
    protected void setProcess() {
//        assertEquals(TestSolution.PASSED,
//                processPageTest("Rgaa22.Test.11.4-1Passed-01").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("Rgaa22.Test.11.4-2Failed-01").getValue());
//        assertEquals(TestSolution.NEED_MORE_INFO,
//                processPageTest("Rgaa22.Test.11.4-3NMI-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("Rgaa22.Test.11.4-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                processPageTest("Rgaa22.Test.11.4-5NT-01").getValue());
    }
...
//                consolidate("Rgaa22.Test.11.4-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa22.Test.11.4-5NT-01").getValue());
    }
