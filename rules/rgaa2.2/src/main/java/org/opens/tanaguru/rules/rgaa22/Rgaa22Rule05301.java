 ...
 * @see <a href="http://rgaa.net/Absence-d-element-bgsound.html"> 5.30 rule specification
 *
 * @author jkowalczyk
 */
public class Rgaa22Rule05301 extends AbstractDetectionPageRuleImplementation {

    /** The element selector */
    private static final ElementSelector ELEMENT_SELECTOR = 
            new SimpleElementSelector(BGSOUND_ELEMENT);
    
    /**
     * Default constructor
     */
    public Rgaa22Rule05301 () {
        super(
                ELEMENT_SELECTOR,
