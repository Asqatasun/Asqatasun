...
/**
 * Unit test class for the implementation of the rule 1.6.10 of the referential RGAA 3.2017
 *
 * @author
 */
public class Rgaa32017Rule010610Test extends Rgaa32017RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa32017.Rgaa32017Rule010610");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa32017.Test.1.6.10-1Passed-01");
//        addWebResource("Rgaa32017.Test.1.6.10-2Failed-01");
...
//        addWebResource("Rgaa32017.Test.1.6.10-4NA-01");
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsPassed(processPageTest("Rgaa32017.Test.1.6.10-1Passed-01"), 1);

        //----------------------------------------------------------------------
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
//        ProcessResult processResult = processPageTest("Rgaa32017.Test.1.6.10-2Failed-01");
...
//        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.1.6.10-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32017.Test.1.6.10-3NMI-01").getValue());
}
