...
public class Rgaa32017Rule111010Test extends Rgaa32017RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa32017.Rgaa32017Rule111010");
    }
...
//        addWebResource("Rgaa32017.Test.11.10.10-2Failed-01");
        addWebResource("Rgaa32017.Test.11.10.10-3NMI-01");
...
//                new ImmutablePair("#ExtractedAttributeAsEvidence", "#ExtractedAttributeValue"));
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa32017.Test.11.10.10-3NMI-01");
...
//        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.11.10.10-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32017.Test.11.10.10-3NMI-01").getValue());
}
