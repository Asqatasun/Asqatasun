...
/**
 * Implementation of the rule 1.8.3 of the referential Rgaa 3.0.
 * <br/>
 * For more details about the implementation, refer to <a href="https://github.com/Tanaguru/Tanaguru-rules-RGAA-3-doc/wiki/Rule-1-8-3">the rule 1.8.3 design page.</a>
 * @see <a href="https://references.modernisation.gouv.fr/sites/default/files/RGAA3/referentiel_technique.htm#test-1-8-3"> 1.8.3 rule specification</a>
 *
 */
public class Rgaa30Rule010803  extends AbstractDetectionPageRuleImplementation {
    
    /**
     * Default constructor
     */
    public Rgaa30Rule010803 () {
        super(
