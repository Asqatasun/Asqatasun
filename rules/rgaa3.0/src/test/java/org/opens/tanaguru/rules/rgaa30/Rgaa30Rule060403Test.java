...
public class Rgaa30Rule060403Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.opens.tanaguru.rules.rgaa30.Rgaa30Rule060403");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa30.Test.06.04.03-1Passed-01");
        addWebResource("Rgaa30.Test.06.04.03-1Passed-02");
        addWebResource("Rgaa30.Test.06.04.03-2Failed-01");
        addWebResource("Rgaa30.Test.06.04.03-2Failed-02");
        addWebResource("Rgaa30.Test.06.04.03-2Failed-03");
        addWebResource("Rgaa30.Test.06.04.03-3NMI-01");
        addWebResource("Rgaa30.Test.06.04.03-3NMI-02");
        addWebResource("Rgaa30.Test.06.04.03-3NMI-03");
        addWebResource("Rgaa30.Test.06.04.03-4NA-01");
        addWebResource("Rgaa30.Test.06.04.03-4NA-02");
        addWebResource("Rgaa30.Test.06.04.03-4NA-03");
        addWebResource("Rgaa30.Test.06.04.03-4NA-04");
        addWebResource("Rgaa30.Test.06.04.03-4NA-05");
