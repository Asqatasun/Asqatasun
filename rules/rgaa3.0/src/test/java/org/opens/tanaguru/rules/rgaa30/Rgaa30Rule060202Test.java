...
public class Rgaa30Rule060202Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.opens.tanaguru.rules.rgaa30.Rgaa30Rule060202");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa30.Test.06.02.02-2Failed-01");
        addWebResource("Rgaa30.Test.06.02.02-2Failed-02");
        addWebResource("Rgaa30.Test.06.02.02-2Failed-03");
        addWebResource("Rgaa30.Test.06.02.02-2Failed-04");
        addWebResource("Rgaa30.Test.06.02.02-3NMI-01");
        addWebResource("Rgaa30.Test.06.02.02-3NMI-02");
        addWebResource("Rgaa30.Test.06.02.02-3NMI-03");
        addWebResource("Rgaa30.Test.06.02.02-3NMI-04");
        addWebResource("Rgaa30.Test.06.02.02-3NMI-05");
        addWebResource("Rgaa30.Test.06.02.02-3NMI-06");
        addWebResource("Rgaa30.Test.06.02.02-4NA-01");
        addWebResource("Rgaa30.Test.06.02.02-4NA-02");
        addWebResource("Rgaa30.Test.06.02.02-4NA-03");
        addWebResource("Rgaa30.Test.06.02.02-4NA-04");
        addWebResource("Rgaa30.Test.06.02.02-4NA-05");
        addWebResource("Rgaa30.Test.06.02.02-4NA-06");
        addWebResource("Rgaa30.Test.06.02.02-4NA-07");
        addWebResource("Rgaa30.Test.06.02.02-4NA-08");
        addWebResource("Rgaa30.Test.06.02.02-4NA-09");
