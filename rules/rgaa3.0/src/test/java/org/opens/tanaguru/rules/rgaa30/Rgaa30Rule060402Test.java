...
/**
 * Unit test class for the implementation of the rule 6-4-2 of the referential Rgaa 3.0.
 *
 * @author jkowalczyk
 */
public class Rgaa30Rule060402Test extends Rgaa30RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa30Rule060402Test (String testName){
        super(testName);
    }

    @Override
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.opens.tanaguru.rules.rgaa30.Rgaa30Rule060402");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa30.Test.06.04.02-1Passed-01");
        addWebResource("Rgaa30.Test.06.04.02-1Passed-02");
        addWebResource("Rgaa30.Test.06.04.02-1Passed-03");
        addWebResource("Rgaa30.Test.06.04.02-1Passed-04");
        addWebResource("Rgaa30.Test.06.04.02-2Failed-01");
        addWebResource("Rgaa30.Test.06.04.02-2Failed-02");
        addWebResource("Rgaa30.Test.06.04.02-2Failed-03");
        addWebResource("Rgaa30.Test.06.04.02-2Failed-04");
        addWebResource("Rgaa30.Test.06.04.02-2Failed-05");
        addWebResource("Rgaa30.Test.06.04.02-2Failed-06");
        addWebResource("Rgaa30.Test.06.04.02-2Failed-07");
        addWebResource("Rgaa30.Test.06.04.02-2Failed-08");
        addWebResource("Rgaa30.Test.06.04.02-3NMI-01");
        addWebResource("Rgaa30.Test.06.04.02-3NMI-02");
        addWebResource("Rgaa30.Test.06.04.02-3NMI-03");
        addWebResource("Rgaa30.Test.06.04.02-4NA-01");
        addWebResource("Rgaa30.Test.06.04.02-4NA-02");
        addWebResource("Rgaa30.Test.06.04.02-4NA-03");
        addWebResource("Rgaa30.Test.06.04.02-4NA-04");
    ...
    protected void setProcess() {
        ProcessResult processResult =
                processPageTest("Rgaa30.Test.06.04.02-1Passed-01");
        assertEquals(TestSolution.PASSED,processResult.getValue());

        processResult = processPageTest("Rgaa30.Test.06.04.02-1Passed-02");
        assertEquals(TestSolution.PASSED,processResult.getValue());

        processResult = processPageTest("Rgaa30.Test.06.04.02-1Passed-03");
        assertEquals(TestSolution.PASSED,processResult.getValue());

        processResult = processPageTest("Rgaa30.Test.06.04.02-1Passed-04");
        assertEquals(TestSolution.PASSED,processResult.getValue());

        processResult = processPageTest("Rgaa30.Test.06.04.02-2Failed-01");
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-2Failed-02");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals(RemarkMessageStore.IDENTICAL_LINK_WITH_DIFFERENT_TARGET,
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-2Failed-03");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals(RemarkMessageStore.IDENTICAL_LINK_WITH_DIFFERENT_TARGET,
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-2Failed-04");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals(RemarkMessageStore.IDENTICAL_LINK_WITH_DIFFERENT_TARGET,
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-2Failed-05");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-2Failed-06");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(4, processResult.getRemarkSet().size());
        assertEquals(RemarkMessageStore.IDENTICAL_LINK_WITH_DIFFERENT_TARGET,
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-2Failed-07");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(4, processResult.getRemarkSet().size());
        assertEquals(RemarkMessageStore.IDENTICAL_LINK_WITH_DIFFERENT_TARGET,
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-2Failed-08");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(4, processResult.getRemarkSet().size());
        assertEquals(RemarkMessageStore.IDENTICAL_LINK_WITH_DIFFERENT_TARGET,
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-3NMI-01");
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-3NMI-02");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals(RemarkMessageStore.SUSPECTED_IDENTICAL_LINK_WITH_DIFFERENT_TARGET,
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-3NMI-03");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals(RemarkMessageStore.SUSPECTED_IDENTICAL_LINK_WITH_DIFFERENT_TARGET,
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("Rgaa30.Test.06.04.02-4NA-01");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("Rgaa30.Test.06.04.02-4NA-02");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("Rgaa30.Test.06.04.02-4NA-03");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("Rgaa30.Test.06.04.02-4NA-04");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("Rgaa30.Test.06.04.02-4NA-05");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("Rgaa30.Test.06.04.02-4NA-06");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.04.02-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.04.02-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.04.02-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.04.02-4NA-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.04.02-4NA-05").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.04.02-4NA-06").getValue());
