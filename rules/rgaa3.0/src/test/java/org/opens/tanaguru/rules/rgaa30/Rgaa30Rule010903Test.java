...
public class Rgaa30Rule010903Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa30.Test.1.9.3-3NMI-01");
        addWebResource("Rgaa30.Test.1.9.3-4NA-01");
        addWebResource("Rgaa30.Test.1.9.3-4NA-02");
        addWebResource("Rgaa30.Test.1.9.3-4NA-03");
    }
