 ...
 */
package org.opens.tanaguru.rules.rgaa30.test;
 ...
 * @author
 */
public abstract class Rgaa30RuleImplementationTestCase extends AbstractRuleImplementationTestCase {
    ...
    public Rgaa30RuleImplementationTestCase(String testName) {
        super(testName, INPUT_FILE_DATA_NAME, TESTCASE_FILE_PATH);
    }
    
    public Rgaa30RuleImplementationTestCase(String testName, String inputFileDataName) {
