...
/**
 * Unit test class for the implementation of the rule 11-4-1 of the referential Rgaa 3.0.
 *
 * @author jkowalczyk
 */
public class Rgaa30Rule110401Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.opens.tanaguru.rules.rgaa30.Rgaa30Rule110401");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa30.Test.11.04.01-3NMI-01");
        addWebResource("Rgaa30.Test.11.04.01-4NA-01");
        addWebResource("Rgaa30.Test.11.04.01-4NA-02");
