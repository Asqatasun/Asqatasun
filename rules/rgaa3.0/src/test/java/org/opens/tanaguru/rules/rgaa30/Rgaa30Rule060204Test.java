...
/**
 * Unit test class for the implementation of the rule 6-2-4 of the referential Rgaa 3.0.
 *
 * @author jkowalczyk
 */
public class Rgaa30Rule060204Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.opens.tanaguru.rules.rgaa30.Rgaa30Rule060204");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa30.Test.06.02.04-2Failed-01");
        addWebResource("Rgaa30.Test.06.02.04-2Failed-02");
        addWebResource("Rgaa30.Test.06.02.04-2Failed-03");
        addWebResource("Rgaa30.Test.06.02.04-2Failed-04");
        addWebResource("Rgaa30.Test.06.02.04-2Failed-05");
        addWebResource("Rgaa30.Test.06.02.04-2Failed-06");
        addWebResource("Rgaa30.Test.06.02.04-2Failed-07");
        addWebResource("Rgaa30.Test.06.02.04-2Failed-08");
        addWebResource("Rgaa30.Test.06.02.04-2Failed-09");
        addWebResource("Rgaa30.Test.06.02.04-2Failed-10");
        addWebResource("Rgaa30.Test.06.02.04-3NMI-01");
        addWebResource("Rgaa30.Test.06.02.04-3NMI-02");
        addWebResource("Rgaa30.Test.06.02.04-3NMI-03");
        addWebResource("Rgaa30.Test.06.02.04-3NMI-04");
        addWebResource("Rgaa30.Test.06.02.04-3NMI-05");
        addWebResource("Rgaa30.Test.06.02.04-3NMI-06");
        addWebResource("Rgaa30.Test.06.02.04-4NA-01");
        addWebResource("Rgaa30.Test.06.02.04-4NA-02");
        addWebResource("Rgaa30.Test.06.02.04-4NA-03");
        addWebResource("Rgaa30.Test.06.02.04-4NA-04");
        addWebResource("Rgaa30.Test.06.02.04-4NA-05");
    ...
    protected void setProcess() {
        ...
        //---------------------------2Failed-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa30.Test.06.02.04-2Failed-01");
        ...
        //---------------------------4NA-01-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa30.Test.06.02.04-4NA-01"));
        
        //----------------------------------------------------------------------
        //---------------------------4NA-02-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa30.Test.06.02.04-4NA-02"),1);
        
        //----------------------------------------------------------------------
        //---------------------------4NA-03-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa30.Test.06.02.04-4NA-03"),1);
        
        //----------------------------------------------------------------------
        //---------------------------4NA-04-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa30.Test.06.02.04-4NA-04"));
        
        //----------------------------------------------------------------------
        //---------------------------4NA-05-------------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa30.Test.06.02.04-4NA-05"));
