 ...
 * @author jkowalczyk
 */
public class Rgaa30Rule060204Test extends Rgaa30RuleImplementationTestCase {
    
    public Rgaa30Rule060204Test(String testName) {
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.rgaa30.Rgaa30Rule060204");
    }
    ...
    protected void setUpWebResourceMap() {
        ...
        getWebResourceMap().put("Rgaa30.Test.06.02.04-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa30/Rgaa30Rule060204/Rgaa30.Test.06.02.04-4NA-01.html"));
        getWebResourceMap().put("Rgaa30.Test.06.02.04-4NA-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa30/Rgaa30Rule060204/Rgaa30.Test.06.02.04-4NA-02.html"));
        getWebResourceMap().put("Rgaa30.Test.06.02.04-4NA-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa30/Rgaa30Rule060204/Rgaa30.Test.06.02.04-4NA-03.html"));
        getWebResourceMap().put("Rgaa30.Test.06.02.04-4NA-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa30/Rgaa30Rule060204/Rgaa30.Test.06.02.04-4NA-04.html"));
        getWebResourceMap().put("Rgaa30.Test.06.02.04-4NA-05",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa30/Rgaa30Rule060204/Rgaa30.Test.06.02.04-4NA-05.html"));
    ...
    protected void setProcess() {
        ProcessResult processResult =
                processPageTest("Rgaa30.Test.06.02.04-2Failed-01");
        ...
        processResult = processPageTest("Rgaa30.Test.06.02.04-4NA-01");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("Rgaa30.Test.06.02.04-4NA-02");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("Rgaa30.Test.06.02.04-4NA-03");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("Rgaa30.Test.06.02.04-4NA-04");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("Rgaa30.Test.06.02.04-4NA-05");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.02.04-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.02.04-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.02.04-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.02.04-4NA-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa30.Test.06.02.04-4NA-05").getValue());
