...
public class Rgaa30Rule060103Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.rgaa30.Rgaa30Rule060103");
    }
    ...
    protected void setUpWebResourceMap() {
        ...
        getWebResourceMap().put("Rgaa30.Test.06.01.03-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa30/Rgaa30Rule060103/Rgaa30.Test.06.01.03-4NA-01.html"));
        getWebResourceMap().put("Rgaa30.Test.06.01.03-4NA-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa30/Rgaa30Rule060103/Rgaa30.Test.06.01.03-4NA-02.html"));
        getWebResourceMap().put("Rgaa30.Test.06.01.03-4NA-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa30/Rgaa30Rule060103/Rgaa30.Test.06.01.03-4NA-03.html"));
        getWebResourceMap().put("Rgaa30.Test.06.01.03-4NA-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa30/Rgaa30Rule060103/Rgaa30.Test.06.01.03-4NA-04.html"));
    ...
    protected void setProcess() {
        ProcessResult processResult =
                processPageTest("Rgaa30.Test.06.01.03-2Failed-01");
        ...
        processResult = processPageTest("Rgaa30.Test.06.01.03-4NA-01");
        assertEquals(TestSolution.NOT_APPLICABLE, processResult.getValue());
        assertNull(processResult.getRemarkSet());
        
        processResult = processPageTest("Rgaa30.Test.06.01.03-4NA-02");
        assertEquals(TestSolution.NOT_APPLICABLE, processResult.getValue());
        assertNull(processResult.getRemarkSet());
        
        processResult = processPageTest("Rgaa30.Test.06.01.03-4NA-03");
        assertEquals(TestSolution.NOT_APPLICABLE, processResult.getValue());
        assertNull(processResult.getRemarkSet());
        
        processResult = processPageTest("Rgaa30.Test.06.01.03-4NA-04");
        assertEquals(TestSolution.NOT_APPLICABLE, processResult.getValue());
        assertNull(processResult.getRemarkSet());
