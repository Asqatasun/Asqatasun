...
/**
 * Unit test class for the implementation of the rule 13-6-1 of the referential Rgaa 3.0.
 *
 * @author jkowalczyk
 */
public class Rgaa30Rule130601Test extends Rgaa30RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.opens.tanaguru.rules.rgaa30.Rgaa30Rule130601");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa30.Test.13.06.01-3NMI-01");
        addWebResource("Rgaa30.Test.13.06.01-3NMI-02");
        addWebResource("Rgaa30.Test.13.06.01-3NMI-03");
        addWebResource("Rgaa30.Test.13.06.01-3NMI-04");
        addWebResource("Rgaa30.Test.13.06.01-3NMI-05");
        addWebResource("Rgaa30.Test.13.06.01-3NMI-06");
        addWebResource("Rgaa30.Test.13.06.01-4NA-01");
        addWebResource("Rgaa30.Test.13.06.01-4NA-02");
        addWebResource("Rgaa30.Test.13.06.01-4NA-03");
    ...
    protected void setProcess() {
       ...
       //----------------------------------------------------------------------
        ...
        //------------------------------4NA--01---------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa30.Test.13.06.01-4NA-01"));
        
        //----------------------------------------------------------------------
        //------------------------------4NA-02----------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa30.Test.13.06.01-4NA-02"),26);
        
        //----------------------------------------------------------------------
        //------------------------------4NA-03----------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa30.Test.13.06.01-4NA-03"));
    }
