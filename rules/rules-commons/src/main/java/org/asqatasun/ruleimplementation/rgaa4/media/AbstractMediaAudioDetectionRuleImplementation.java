...
import static org.asqatasun.rules.keystore.CssLikeQueryStore.LINK_MEDIA_AUDIO_CSS_LIKE_QUERY;
import static org.asqatasun.rules.keystore.CssLikeQueryStore.MEDIA_AUDIO_CSS_LIKE_QUERY;
...
public abstract class AbstractMediaAudioDetectionRuleImplementation extends AbstractDetectionPageRuleImplementation {
    ...
    public AbstractMediaAudioDetectionRuleImplementation() {
        super(
            new SimpleElementSelector(MEDIA_AUDIO_CSS_LIKE_QUERY + ", " + LINK_MEDIA_AUDIO_CSS_LIKE_QUERY),
