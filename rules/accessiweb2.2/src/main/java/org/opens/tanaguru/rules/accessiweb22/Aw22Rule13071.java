...
import static org.opens.tanaguru.rules.keystore.RemarkMessageStore.OFFICE_DOCUMENT_DETECTED_MSG;
import org.opens.tanaguru.rules.textbuilder.TextAttributeOfElementBuilder;

/**
 * Implementation of the rule 13.7.1 of the referential Accessiweb 2.2.
 * <br/>
 * For more details about the implementation, refer to <a href="http://www.tanaguru.org/en/content/aw22-rule-13-7-1">the rule 13.7.1 design page.</a>
 * @see <a href="http://www.accessiweb.org/index.php/accessiweb-22-english-version.html#test-13-7-1"> 13.7.1 rule specification</a>
 *
 * @author jkowalczyk
 */

public class Aw22Rule13071 extends AbstractDownloadableLinkRuleImplementation {
