...
/**
 * Unit test class for the implementation of the rule 11.4.1 of the referential Accessiweb 2.2.
 *
 * @author jkowalczyk
 */
public class Aw22Rule11041Test extends Aw22RuleImplementationTestCase {

    /**
     * Default constructor
     */
    public Aw22Rule11041Test (String testName){
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule11041");
    }

     @Override
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.11.4.1-3NMI-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule11041/AW22.Test.11.4.1-3NMI-01.html"));
        getWebResourceMap().put("AW22.Test.11.4.1-4NA-01",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "accessiweb22/Aw22Rule11041/AW22.Test.11.4.1-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.11.4.1-4NA-02",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "accessiweb22/Aw22Rule11041/AW22.Test.11.4.1-4NA-02.html"));
    }
    ...
    protected void setConsolidate() {
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("AW22.Test.11.4.1-3NMI-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW22.Test.11.4.1-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW22.Test.11.4.1-4NA-02").getValue());
    }
