...
public class Aw22Rule09022Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule09022");
    }
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.9.2.2-3NMI-01",
                ...
                getTestcasesFilePath() + "AW22/Aw22Rule09022/AW22.Test.9.2.2-3NMI-01.html"));
//        getWebResourceMap().put("AW22.Test.9.2.2-3NMI-02",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule09022/AW22.Test.9.2.2-3NMI-02.html"));
//        getWebResourceMap().put("AW22.Test.9.2.2-3NMI-03",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule09022/AW22.Test.9.2.2-3NMI-03.html"));
//        getWebResourceMap().put("AW22.Test.9.2.2-3NMI-04",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule09022/AW22.Test.9.2.2-3NMI-04.html"));
    }
