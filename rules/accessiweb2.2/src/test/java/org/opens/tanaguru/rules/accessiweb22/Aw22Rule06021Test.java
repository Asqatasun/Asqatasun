...
public class Aw22Rule06021Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setProcess() {
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW22.Test.06.02.01-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW22.Test.06.02.01-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW22.Test.06.02.01-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW22.Test.06.02.01-4NA-04").getValue());
