...
public class Aw22Rule01091Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule01091");
    }
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.1.9.1-3NMI-01",
                ...
                getTestcasesFilePath() + "AW22/Aw22Rule01091/AW22.Test.1.9.1-3NMI-01.html"));
        getWebResourceMap().put("AW22.Test.1.9.1-4NA-01",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01091/AW22.Test.1.9.1-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.1.9.1-4NA-02",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01091/AW22.Test.1.9.1-4NA-02.html"));
    }
