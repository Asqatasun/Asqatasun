...
/**
 * Unit test class for the implementation of the rule 6.5.2 of the referential Accessiweb 2.2.
 *
 * @author jkowalczyk
 */
public class Aw22Rule06052Test extends Aw22RuleImplementationTestCase {

    /**
     * Default constructor
     */
    public Aw22Rule06052Test (String testName){
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule06052");
    }
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.6.5.2-3NMI-01",
                ...
                getTestcasesFilePath() + "accessiweb22/Aw22Rule06052/AW22.Test.6.5.2-3NMI-01.html"));
        getWebResourceMap().put("AW22.Test.6.5.2-3NMI-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule06052/AW22.Test.6.5.2-3NMI-02.html"));
        getWebResourceMap().put("AW22.Test.6.5.2-4NA-01",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "accessiweb22/Aw22Rule06052/AW22.Test.6.5.2-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.6.5.2-4NA-02",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "accessiweb22/Aw22Rule06052/AW22.Test.6.5.2-4NA-02.html"));
    }
    ...
    protected void setProcess() {
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("AW22.Test.6.5.2-3NMI-01");
        ...
        //------------------------------4NA-01----------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("AW22.Test.6.5.2-4NA-02");
        // check test result
        assertEquals(TestSolution.NOT_APPLICABLE, processResult.getValue());
        // check test has no remark
        assertNull(processResult.getRemarkSet());
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW22.Test.6.5.2-4NA-02").getValue());
    }
