...
public class Aw22Rule08082Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule08082");
    }
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.8.8.2-3NMI-01",
                ...
                getTestcasesFilePath() + "AW22/Aw22Rule08082/AW22.Test.8.8.2-3NMI-01.html"));
        getWebResourceMap().put("AW22.Test.8.8.2-3NMI-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08082/AW22.Test.8.8.2-3NMI-02.html"));
        getWebResourceMap().put("AW22.Test.8.8.2-3NMI-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08082/AW22.Test.8.8.2-3NMI-03.html"));
        getWebResourceMap().put("AW22.Test.8.8.2-3NMI-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08082/AW22.Test.8.8.2-3NMI-04.html"));
        getWebResourceMap().put("AW22.Test.8.8.2-4NA-01",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule08082/AW22.Test.8.8.2-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.8.8.2-4NA-02",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule08082/AW22.Test.8.8.2-4NA-02.html"));
    }
    ...
    protected void setProcess() {
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("AW22.Test.8.8.2-3NMI-01");
        ...
        //------------------------------3NMI-04------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("AW22.Test.8.8.2-3NMI-04");
        // check number of elements in the page
        assertEquals(1, processResult.getElementCounter());
        // check test result
        assertEquals(TestSolution.NEED_MORE_INFO, processResult.getValue());
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("AW22.Test.8.8.2-3NMI-04").getValue());
