...
public class Aw22Rule12114Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule12114");
    }
...
//              getTestcasesFilePath() + "AW22/Aw22Rule12114/AW22.Test.12.11.4-1Passed-01.html"));
//        getWebResourceMap().put("AW22.Test.12.11.4-2Failed-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "AW22/Aw22Rule12114/AW22.Test.12.11.4-2Failed-01.html"));
        getWebResourceMap().put("AW22.Test.12.11.4-3NMI-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule12114/AW22.Test.12.11.4-3NMI-01.html"));
//        getWebResourceMap().put("AW22.Test.12.11.4-4NA-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "AW22/Aw22Rule12114/AW22.Test.12.11.4-4NA-01.html"));
    }
