...
public class Aw22Rule06011Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule06011");
    }
...
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06011/AW22.Test.06.01.01-4NA-01.html"));
//        getWebResourceMap().put("AW22.Test.06.01.01-4NA-02",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06011/AW22.Test.06.01.01-4NA-02.html"));
//        getWebResourceMap().put("AW22.Test.06.01.01-4NA-03",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06011/AW22.Test.06.01.01-4NA-03.html"));
//        getWebResourceMap().put("AW22.Test.06.01.01-4NA-04",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06011/AW22.Test.06.01.01-4NA-04.html"));
//        getWebResourceMap().put("AW22.Test.06.01.01-4NA-05",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06011/AW22.Test.06.01.01-4NA-05.html"));
//
//        //06.01.02 testcases
...
//                processPageTest("AW22.Test.06.01.01-4NA-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.01-4NA-02").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.01-4NA-03").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.01-4NA-04").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.01-4NA-05").getValue());
//
