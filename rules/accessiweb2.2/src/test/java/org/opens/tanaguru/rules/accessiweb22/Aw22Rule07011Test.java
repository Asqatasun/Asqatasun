...
public class Aw22Rule07011Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule07011");
    }
...
//              getTestcasesFilePath() + "AW22/Aw22Rule07011/AW22.Test.7.1.1-1Passed-01.html"));
//        getWebResourceMap().put("AW22.Test.7.1.1-2Failed-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "AW22/Aw22Rule07011/AW22.Test.7.1.1-2Failed-01.html"));
        getWebResourceMap().put("AW22.Test.7.1.1-3NMI-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule07011/AW22.Test.7.1.1-3NMI-01.html"));
//        getWebResourceMap().put("AW22.Test.7.1.1-4NA-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "AW22/Aw22Rule07011/AW22.Test.7.1.1-4NA-01.html"));
    }
