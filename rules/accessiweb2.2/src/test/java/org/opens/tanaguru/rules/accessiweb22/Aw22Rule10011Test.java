...
public class Aw22Rule10011Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName( "org.opens.tanaguru.rules.accessiweb22.Aw22Rule10011");
    }
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.10.1.1-1Passed-01",
                ...
                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-1Passed-01.html"));
//        getWebResourceMap().put("AW22.Test.10.1.1-2Failed-01",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-2Failed-01.html"));
//        getWebResourceMap().put("AW22.Test.10.1.1-2Failed-02",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-2Failed-02.html"));
//        getWebResourceMap().put("AW22.Test.10.1.1-2Failed-03",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-2Failed-03.html"));
//        getWebResourceMap().put("AW22.Test.10.1.1-2Failed-04",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-2Failed-04.html"));
//        getWebResourceMap().put("AW22.Test.10.1.1-2Failed-05",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-2Failed-05.html"));
//        getWebResourceMap().put("AW22.Test.10.1.1-2Failed-06",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-2Failed-06.html"));
//        getWebResourceMap().put("AW22.Test.10.1.1-2Failed-07",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-2Failed-07.html"));
//        getWebResourceMap().put("AW22.Test.10.1.1-2Failed-08",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-2Failed-08.html"));
//        getWebResourceMap().put("AW22.Test.10.1.1-2Failed-09",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule10011/AW22.Test.10.1.1-2Failed-09.html"));
    }

    @Override
    protected void setProcess() {
        assertEquals(TestSolution.NOT_TESTED,
                processPageTest("AW22.Test.10.1.1-1Passed-01").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.10.1.1-2Failed-01").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.10.1.1-2Failed-02").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.10.1.1-2Failed-03").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.10.1.1-2Failed-04").getValue());
...
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.10.1.1-2Failed-05").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.10.1.1-2Failed-06").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.10.1.1-2Failed-07").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.10.1.1-2Failed-08").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.10.1.1-2Failed-09").getValue());
    }
