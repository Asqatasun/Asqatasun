...
public class Aw22Rule03022Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule03022");
    }
...
//              getTestcasesFilePath() + "AW22/Aw22Rule03022/AW22.Test.3.2.2-1Passed-01.html"));
//        getWebResourceMap().put("AW22.Test.3.2.2-2Failed-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "AW22/Aw22Rule03022/AW22.Test.3.2.2-2Failed-01.html"));
        getWebResourceMap().put("AW22.Test.3.2.2-3NMI-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule03022/AW22.Test.3.2.2-3NMI-01.html"));
//        getWebResourceMap().put("AW22.Test.3.2.2-4NA-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "AW22/Aw22Rule03022/AW22.Test.3.2.2-4NA-01.html"));
    }
