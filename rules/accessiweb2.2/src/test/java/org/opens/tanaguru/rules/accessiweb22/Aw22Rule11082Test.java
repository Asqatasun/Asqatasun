...
public class Aw22Rule11082Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule11082");
    }
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.11.8.2-1Passed-01",
                ...
                getTestcasesFilePath() + "AW22/Aw22Rule11082/AW22.Test.11.8.2-1Passed-01.html"));
        getWebResourceMap().put("AW22.Test.11.8.2-1Passed-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule11082/AW22.Test.11.8.2-1Passed-02.html"));
        getWebResourceMap().put("AW22.Test.11.8.2-2Failed-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule11082/AW22.Test.11.8.2-2Failed-01.html"));
        getWebResourceMap().put("AW22.Test.11.8.2-2Failed-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule11082/AW22.Test.11.8.2-2Failed-02.html"));
        getWebResourceMap().put("AW22.Test.11.8.2-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule11082/AW22.Test.11.8.2-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.11.8.2-4NA-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule11082/AW22.Test.11.8.2-4NA-02.html"));
    }
