...
public class Aw22Rule13062Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.13.6.2-3NMI-01",
                ...
                getTestcasesFilePath() + "AW22/Aw22Rule13062/AW22.Test.13.6.2-3NMI-01.html"));
        getWebResourceMap().put("AW22.Test.13.6.2-3NMI-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule13062/AW22.Test.13.6.2-3NMI-02.html"));
        getWebResourceMap().put("AW22.Test.13.6.2-3NMI-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule13062/AW22.Test.13.6.2-3NMI-03.html"));
        getWebResourceMap().put("AW22.Test.13.6.2-3NMI-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule13062/AW22.Test.13.6.2-3NMI-04.html"));
        getWebResourceMap().put("AW22.Test.13.6.2-3NMI-05",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule13062/AW22.Test.13.6.2-3NMI-05.html"));
        getWebResourceMap().put("AW22.Test.13.6.2-3NMI-06",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule13062/AW22.Test.13.6.2-3NMI-06.html"));
        getWebResourceMap().put("AW22.Test.13.6.2-4NA-01",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule13062/AW22.Test.13.6.2-4NA-01.html"));
