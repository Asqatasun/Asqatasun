...
//        getWebResourceMap().put("AW22.Test.13.6.3-1Passed-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "AW22/Aw22Rule13063/AW22.Test.13.6.3-1Passed-01.html"));
//        getWebResourceMap().put("AW22.Test.13.6.3-2Failed-01",
//              getWebResourceFactory().createPage(
//              getTestcasesFilePath() + "AW22/Aw22Rule13063/AW22.Test.13.6.3-2Failed-01.html"));
...
//                processPageTest("AW22.Test.13.6.3-1Passed-01").getValue());
//        assertEquals(TestSolution.FAILED,
//                processPageTest("AW22.Test.13.6.3-2Failed-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                processPageTest("AW22.Test.13.6.3-3NMI-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.13.6.3-4NA-01").getValue());
    }

    @Override
    protected void setConsolidate() {
//        assertEquals(TestSolution.PASSED,
//                consolidate("AW22.Test.13.6.3-1Passed-01").getValue());
//        assertEquals(TestSolution.FAILED,
//                consolidate("AW22.Test.13.6.3-2Failed-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
