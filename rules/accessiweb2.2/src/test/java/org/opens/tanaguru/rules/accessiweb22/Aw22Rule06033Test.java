...
public class Aw22Rule06033Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule06033");
    }
...
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06033/AW22.Test.06.03.03-4NA-01.html"));
//        getWebResourceMap().put("AW22.Test.06.03.03-4NA-02",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06033/AW22.Test.06.03.03-4NA-02.html"));
//        getWebResourceMap().put("AW22.Test.06.03.03-4NA-03",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06033/AW22.Test.06.03.03-4NA-03.html"));
//        getWebResourceMap().put("AW22.Test.06.03.03-4NA-04",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06033/AW22.Test.06.03.03-4NA-04.html"));
//
//        // 06.03.01 testcases
...
//                getTestcasesFilePath() + "AW22/Aw22Rule06032/AW22.Test.06.03.02-3NMI-06.html"));
    ...
    protected void setProcess() {
        ProcessResult processResult =
                processPageTest("AW22.Test.06.03.03-2Failed-01");
...
//                processPageTest("AW22.Test.06.03.03-4NA-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.03.03-4NA-02").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.03.03-4NA-03").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.03.03-4NA-04").getValue());
//
