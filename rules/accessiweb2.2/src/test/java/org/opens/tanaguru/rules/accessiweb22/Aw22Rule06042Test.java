...
public class Aw22Rule06042Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpWebResourceMap() {
        ...
        getWebResourceMap().put("AW22.Test.06.04.02-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule06042/AW22.Test.06.04.02-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.06.04.02-4NA-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule06042/AW22.Test.06.04.02-4NA-02.html"));
        getWebResourceMap().put("AW22.Test.06.04.02-4NA-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule06042/AW22.Test.06.04.02-4NA-03.html"));
        getWebResourceMap().put("AW22.Test.06.04.02-4NA-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule06042/AW22.Test.06.04.02-4NA-04.html"));
        getWebResourceMap().put("AW22.Test.06.04.02-4NA-05",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule06042/AW22.Test.06.04.02-4NA-05.html"));
        getWebResourceMap().put("AW22.Test.06.04.02-4NA-06",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule06042/AW22.Test.06.04.02-4NA-06.html"));
