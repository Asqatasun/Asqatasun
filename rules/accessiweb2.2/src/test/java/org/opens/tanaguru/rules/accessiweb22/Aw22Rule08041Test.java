...
public class Aw22Rule08041Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpWebResourceMap() {
        ...
        getWebResourceMap().put("AW22.Test.8.4.1-2Failed-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08041/AW22.Test.8.4.1-2Failed-02.html"));
        getWebResourceMap().put("AW22.Test.8.4.1-2Failed-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08041/AW22.Test.8.4.1-2Failed-03.html"));
        getWebResourceMap().put("AW22.Test.8.4.1-2Failed-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08041/AW22.Test.8.4.1-2Failed-04.html"));
        getWebResourceMap().put("AW22.Test.8.4.1-2Failed-05",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08041/AW22.Test.8.4.1-2Failed-05.html"));
        getWebResourceMap().put("AW22.Test.8.4.1-2Failed-06",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08041/AW22.Test.8.4.1-2Failed-06.html"));
        getWebResourceMap().put("AW22.Test.8.4.1-3NMI-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08041/AW22.Test.8.4.1-3NMI-01.html"));
        getWebResourceMap().put("AW22.Test.8.4.1-3NMI-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule08041/AW22.Test.8.4.1-3NMI-02.html"));
