...
public class Aw22Rule01063Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule01063");
    }
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.1.6.3-3NMI-01",
                ...
                getTestcasesFilePath() + "AW22/Aw22Rule01063/AW22.Test.1.6.3-3NMI-01.html"));
        getWebResourceMap().put("AW22.Test.1.6.3-3NMI-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule01063/AW22.Test.1.6.3-3NMI-02.html"));
        ...
        getWebResourceMap().put("AW22.Test.1.6.3-3NMI-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule01063/AW22.Test.1.6.3-3NMI-03.html"));
        ...
        getWebResourceMap().put("AW22.Test.1.6.3-4NA-01",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01063/AW22.Test.1.6.3-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.1.6.3-4NA-02",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01063/AW22.Test.1.6.3-4NA-02.html"));
        getWebResourceMap().put("AW22.Test.1.6.3-4NA-03",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01063/AW22.Test.1.6.3-4NA-03.html"));
        getWebResourceMap().put("AW22.Test.1.6.3-4NA-04",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01063/AW22.Test.1.6.3-4NA-04.html"));
