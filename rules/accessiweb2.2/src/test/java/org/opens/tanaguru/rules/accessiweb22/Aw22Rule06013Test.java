...
public class Aw22Rule06013Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule06013");
    }
...
////        getWebResourceMap().put("AW22.Test.06.01.03-3NMI-04",
////                getWebResourceFactory().createPage(
////                getTestcasesFilePath() + "AW22/Aw22Rule06013/AW22.Test.06.01.03-3NMI-04.html"));
...
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06013/AW22.Test.06.01.03-4NA-01.html"));
//        getWebResourceMap().put("AW22.Test.06.01.03-4NA-02",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06013/AW22.Test.06.01.03-4NA-02.html"));
//        getWebResourceMap().put("AW22.Test.06.01.03-4NA-03",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06013/AW22.Test.06.01.03-4NA-03.html"));
//        getWebResourceMap().put("AW22.Test.06.01.03-4NA-04",
//                getWebResourceFactory().createPage(
//                getTestcasesFilePath() + "AW22/Aw22Rule06013/AW22.Test.06.01.03-4NA-04.html"));
//
//        // 06.01.01 testcases
...
//                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
//
////        processResult = processPageTest("AW22.Test.06.01.03-3NMI-04");
////        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
////        assertEquals("SuspectedUnexplicitContext",
////                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
////        assertEquals("SuspectedUnexplicitContext",
...
//                processPageTest("AW22.Test.06.01.03-4NA-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.03-4NA-02").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.03-4NA-03").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.03-4NA-04").getValue());
//
...
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-02").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-03").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-04").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-05").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-06").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-07").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-08").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-09").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-10").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-11").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-2Failed-12").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-3NMI-01").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-3NMI-02").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-3NMI-03").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-3NMI-05").getValue());
//        assertEquals(TestSolution.NOT_APPLICABLE,
//                processPageTest("AW22.Test.06.01.02-3NMI-06").getValue());
    }
...
////        assertEquals(TestSolution.NEED_MORE_INFO,
////                consolidate("AW22.Test.06.01.03-3NMI-04").getValue());
//        assertEquals(TestSolution.NEED_MORE_INFO,
