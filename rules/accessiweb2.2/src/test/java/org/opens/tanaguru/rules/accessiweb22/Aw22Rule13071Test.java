...
/**
 * Unit test class for the implementation of the rule 13.7.1 of the referential Accessiweb 2.2.
 *
 * @author jkowalczyk
 */
public class Aw22Rule13071Test extends Aw22RuleImplementationTestCase {

    /**
     * Default constructor
     */
    public Aw22Rule13071Test (String testName){
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule13071");
    }

    @Override
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.13.7.1-3NMI-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule13071/AW22.Test.13.7.1-3NMI-01.html"));
        getWebResourceMap().put("AW22.Test.13.7.1-3NMI-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule13071/AW22.Test.13.7.1-3NMI-02.html"));
        getWebResourceMap().put("AW22.Test.13.7.1-3NMI-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule13071/AW22.Test.13.7.1-3NMI-03.html"));
        getWebResourceMap().put("AW22.Test.13.7.1-3NMI-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule13071/AW22.Test.13.7.1-3NMI-04.html"));
        getWebResourceMap().put("AW22.Test.13.7.1-3NMI-05",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule13071/AW22.Test.13.7.1-3NMI-05.html"));
        getWebResourceMap().put("AW22.Test.13.7.1-3NMI-06",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "accessiweb22/Aw22Rule13071/AW22.Test.13.7.1-3NMI-06.html"));
        getWebResourceMap().put("AW22.Test.13.7.1-4NA-01",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "accessiweb22/Aw22Rule13071/AW22.Test.13.7.1-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.13.7.1-4NA-02",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "accessiweb22/Aw22Rule13071/AW22.Test.13.7.1-4NA-02.html"));
        getWebResourceMap().put("AW22.Test.13.7.1-4NA-03",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "accessiweb22/Aw22Rule13071/AW22.Test.13.7.1-4NA-03.html"));
    }
    ...
    protected void setConsolidate() {
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("AW22.Test.13.7.1-3NMI-01").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("AW22.Test.13.7.1-3NMI-02").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("AW22.Test.13.7.1-3NMI-03").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("AW22.Test.13.7.1-3NMI-04").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("AW22.Test.13.7.1-3NMI-05").getValue());
        assertEquals(TestSolution.NEED_MORE_INFO,
                consolidate("AW22.Test.13.7.1-3NMI-06").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW22.Test.13.7.1-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW22.Test.13.7.1-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW22.Test.13.7.1-4NA-03").getValue());
    }
