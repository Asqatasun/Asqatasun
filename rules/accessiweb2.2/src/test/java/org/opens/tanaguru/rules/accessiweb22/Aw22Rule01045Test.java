...
public class Aw22Rule01045Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule01045");
    }
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.1.4.5-3NMI-01",
                ...
                getTestcasesFilePath() + "AW22/Aw22Rule01045/AW22.Test.1.4.5-3NMI-01.html"));
        getWebResourceMap().put("AW22.Test.1.4.5-4NA-01",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01045/AW22.Test.1.4.5-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.1.4.5-4NA-02",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01045/AW22.Test.1.4.5-4NA-02.html"));
        getWebResourceMap().put("AW22.Test.1.4.5-4NA-03",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01045/AW22.Test.1.4.5-4NA-03.html"));
        getWebResourceMap().put("AW22.Test.1.4.5-4NA-04",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01045/AW22.Test.1.4.5-4NA-04.html"));
        getWebResourceMap().put("AW22.Test.1.4.5-4NA-05",
              getWebResourceFactory().createPage(
              getTestcasesFilePath() + "AW22/Aw22Rule01045/AW22.Test.1.4.5-4NA-05.html"));
    }
