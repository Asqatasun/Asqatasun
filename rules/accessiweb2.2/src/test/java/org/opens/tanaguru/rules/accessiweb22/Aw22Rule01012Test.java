...
public class Aw22Rule01012Test extends Aw22RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb22.Aw22Rule01012");
    }
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("AW22.Test.1.1.2-1Passed-01",
                ...
                getTestcasesFilePath() + "AW22/Aw22Rule01012/AW22.Test.1.1.2-1Passed-01.html"));
        getWebResourceMap().put("AW22.Test.1.1.2-1Passed-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule01012/AW22.Test.1.1.2-1Passed-02.html"));
        getWebResourceMap().put("AW22.Test.1.1.2-1Passed-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule01012/AW22.Test.1.1.2-1Passed-03.html"));
        getWebResourceMap().put("AW22.Test.1.1.2-2Failed-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule01012/AW22.Test.1.1.2-2Failed-01.html"));
        getWebResourceMap().put("AW22.Test.1.1.2-2Failed-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule01012/AW22.Test.1.1.2-2Failed-02.html"));
        getWebResourceMap().put("AW22.Test.1.1.2-2Failed-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule01012/AW22.Test.1.1.2-2Failed-03.html"));
        getWebResourceMap().put("AW22.Test.1.1.2-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule01012/AW22.Test.1.1.2-4NA-01.html"));
        getWebResourceMap().put("AW22.Test.1.1.2-4NA-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule01012/AW22.Test.1.1.2-4NA-02.html"));
    }
