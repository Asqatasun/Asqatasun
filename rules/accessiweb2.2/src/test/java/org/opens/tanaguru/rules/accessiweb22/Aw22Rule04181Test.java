...
getWebResourceMap().put("AW22.Test.4.18.1-3NMI-01",
        ...
        getWebResourceMap().put("AW22.Test.4.18.1-3NMI-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule04181/AW22.Test.4.18.1-3NMI-02.html"));
        getWebResourceMap().put("AW22.Test.4.18.1-3NMI-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule04181/AW22.Test.4.18.1-3NMI-03.html"));
        getWebResourceMap().put("AW22.Test.4.18.1-3NMI-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule04181/AW22.Test.4.18.1-3NMI-04.html"));
        getWebResourceMap().put("AW22.Test.4.18.1-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW22/Aw22Rule04181/AW22.Test.4.18.1-4NA-04.html"));
    }
