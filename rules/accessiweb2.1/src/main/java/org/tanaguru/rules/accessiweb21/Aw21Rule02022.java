 ...
 * <br/>
 * For more details about the implementation, refer to <a href="http://www.tanaguru.org/en/content/aw21-rule-2-2-2">the rule 2.2.2 design page.</a>
 * @see <a href="http://www.braillenet.org/accessibilite/referentiel-aw21-en/index.php#test-2-2-2"> 2.2.2 rule specification</a>
 *
 * @author jkowalczyk
 */

public class Aw21Rule02022 extends AbstractTagDetectionPageRuleImplementation {

    public static final String MESSAGE_CODE = "ManualCheckOnElements";
    private static final String TAG_DETECTION_XPATH_EXPR ="//IFRAME[@title]";

    /**
     * Default constructor
     */
    public Aw21Rule02022 () {
        super();
