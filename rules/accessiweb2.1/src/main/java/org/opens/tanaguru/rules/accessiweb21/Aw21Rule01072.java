...
/**
 * Implementation of the rule 1.7.2 of the referential Accessiweb 2.1.
 * <br/>
 * For more details about the implementation, refer to <a href="http://www.tanaguru.org/en/content/aw21-rule-1-7-2">the rule 1.7.2 design page.</a>
 * @see <a href="http://www.braillenet.org/accessibilite/referentiel-aw21-en/index.php#test-1-7-2"> 1.7.2 rule specification</a>
 *
 * @author jkowalczyk
 */

public class Aw21Rule01072 extends AbstractTagDetectionPageRuleImplementation {
