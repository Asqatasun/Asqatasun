...
/**
 * Implementation of the rule 1.3.5 of the referential Accessiweb 2.1.
 * <br/>
 * For more details about the implementation, refer to <a href="http://www.tanaguru.org/en/content/aw21-rule-1-3-5">the rule 1.3.5 design page.</a>
 * @see <a href="http://www.braillenet.org/accessibilite/referentiel-aw21-en/index.php#test-1-3-5"> 1.3.5 rule specification</a>
 *
 * @author jkowalczyk
 */

public class Aw21Rule01035 extends AbstractTagDetectionPageRuleImplementation {
