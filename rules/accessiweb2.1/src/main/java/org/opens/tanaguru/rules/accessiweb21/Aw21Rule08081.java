...
/**
 * Implementation of the rule 8.8.1 of the referential Accessiweb 2.1.
 * <br/>
 * For more details about the implementation, refer to <a href="http://www.tanaguru.org/en/content/aw21-rule-8-8-1">the rule 8.8.1 design page.</a>
 * @see <a href="http://www.braillenet.org/accessibilite/referentiel-aw21-en/index.php#test-8-8-1"> 8.8.1 rule specification</a>
 *
 * @author jkowalczyk
 */

public class Aw21Rule08081 extends AbstractTagDetectionPageRuleImplementation {
