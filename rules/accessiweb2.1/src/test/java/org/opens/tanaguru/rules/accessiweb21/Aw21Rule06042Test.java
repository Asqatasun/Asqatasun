 ...
 * @author jkowalczyk
 */
public class Aw21Rule06042Test extends Aw21RuleImplementationTestCase {

    public Aw21Rule06042Test(String testName) {
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb21.Aw21Rule06042");
    }
    ...
    protected void setUpWebResourceMap() {
        ...
        getWebResourceMap().put("AW21.Test.06.04.02-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06042/AW21.Test.06.04.02-4NA-01.html"));
        getWebResourceMap().put("AW21.Test.06.04.02-4NA-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06042/AW21.Test.06.04.02-4NA-02.html"));
        getWebResourceMap().put("AW21.Test.06.04.02-4NA-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06042/AW21.Test.06.04.02-4NA-03.html"));
        getWebResourceMap().put("AW21.Test.06.04.02-4NA-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06042/AW21.Test.06.04.02-4NA-04.html"));
        getWebResourceMap().put("AW21.Test.06.04.02-4NA-05",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06042/AW21.Test.06.04.02-4NA-05.html"));
        getWebResourceMap().put("AW21.Test.06.04.02-4NA-06",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06042/AW21.Test.06.04.02-4NA-06.html"));
    ...
    protected void setProcess() {
        ProcessResult processResult =
                processPageTest("AW21.Test.06.04.02-1Passed-01");
        assertEquals(TestSolution.PASSED,processResult.getValue());

        processResult = processPageTest("AW21.Test.06.04.02-1Passed-02");
        assertEquals(TestSolution.PASSED,processResult.getValue());

        processResult = processPageTest("AW21.Test.06.04.02-1Passed-03");
        assertEquals(TestSolution.PASSED,processResult.getValue());

        processResult = processPageTest("AW21.Test.06.04.02-1Passed-04");
        assertEquals(TestSolution.PASSED,processResult.getValue());

        processResult = processPageTest("AW21.Test.06.04.02-2Failed-01");
        ...
        processResult = processPageTest("AW21.Test.06.04.02-2Failed-02");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals("IdenticalLinkWithDifferentTarget",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("AW21.Test.06.04.02-2Failed-03");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals("IdenticalLinkWithDifferentTarget",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("AW21.Test.06.04.02-2Failed-04");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals("IdenticalLinkWithDifferentTarget",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("AW21.Test.06.04.02-2Failed-05");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        ...
        processResult = processPageTest("AW21.Test.06.04.02-2Failed-06");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(4, processResult.getRemarkSet().size());
        assertEquals("IdenticalLinkWithDifferentTarget",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("AW21.Test.06.04.02-2Failed-07");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(4, processResult.getRemarkSet().size());
        assertEquals("IdenticalLinkWithDifferentTarget",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("AW21.Test.06.04.02-2Failed-08");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals(4, processResult.getRemarkSet().size());
        assertEquals("IdenticalLinkWithDifferentTarget",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("AW21.Test.06.04.02-3NMI-01");
        ...
        processResult = processPageTest("AW21.Test.06.04.02-3NMI-02");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals("SuspectedIdenticalLinkWithDifferentTarget",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("AW21.Test.06.04.02-3NMI-03");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertEquals(2, processResult.getRemarkSet().size());
        assertEquals("SuspectedIdenticalLinkWithDifferentTarget",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        ...
        processResult = processPageTest("AW21.Test.06.04.02-4NA-01");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.04.02-4NA-02");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.04.02-4NA-03");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.04.02-4NA-04");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.04.02-4NA-05");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.04.02-4NA-06");
        assertEquals(TestSolution.NOT_APPLICABLE,processResult.getValue());
        assertNull(processResult.getRemarkSet());
        
        // 06.04.01 testcases : All is Not Applicable
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.04.01-1Passed-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.04.01-1Passed-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.04.01-2Failed-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.04.01-2Failed-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.04.01-2Failed-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.04.01-3NMI-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.04.01-3NMI-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.04.01-3NMI-03").getValue());
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.04.02-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.04.02-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.04.02-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.04.02-4NA-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.04.02-4NA-05").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.04.02-4NA-06").getValue());
