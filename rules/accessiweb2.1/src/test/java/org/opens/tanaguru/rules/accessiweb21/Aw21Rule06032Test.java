 ...
 * @author jkowalczyk
 */
public class Aw21Rule06032Test extends Aw21RuleImplementationTestCase {

    public Aw21Rule06032Test(String testName) {
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.opens.tanaguru.rules.accessiweb21.Aw21Rule06032");
    }
    ...
    protected void setUpWebResourceMap() {
        ...
        getWebResourceMap().put("AW21.Test.06.03.02-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06032/AW21.Test.06.03.02-4NA-01.html"));
        getWebResourceMap().put("AW21.Test.06.03.02-4NA-02",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06032/AW21.Test.06.03.02-4NA-02.html"));
        getWebResourceMap().put("AW21.Test.06.03.02-4NA-03",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06032/AW21.Test.06.03.02-4NA-03.html"));
        getWebResourceMap().put("AW21.Test.06.03.02-4NA-04",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06032/AW21.Test.06.03.02-4NA-04.html"));
        getWebResourceMap().put("AW21.Test.06.03.02-4NA-05",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "AW21/Aw21Rule06032/AW21.Test.06.03.02-4NA-05.html"));
    ...
    protected void setProcess() {
        ProcessResult processResult =
                processPageTest("AW21.Test.06.03.02-2Failed-01");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());

        processResult = processPageTest("AW21.Test.06.03.02-2Failed-02");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());

        processResult = processPageTest("AW21.Test.06.03.02-2Failed-03");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());

        processResult = processPageTest("AW21.Test.06.03.02-2Failed-04");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());

        processResult = processPageTest("AW21.Test.06.03.02-2Failed-05");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        assertEquals("UnexplicitLinkOutOfContext",
        ...
        processResult = processPageTest("AW21.Test.06.03.02-2Failed-06");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        assertEquals("UnexplicitLinkOutOfContext",
        ...
        processResult = processPageTest("AW21.Test.06.03.02-2Failed-07");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        assertEquals("UnexplicitLinkOutOfContext",
        ...
        processResult = processPageTest("AW21.Test.06.03.02-2Failed-08");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());
        assertEquals("UnexplicitLinkOutOfContext",
        ...
        processResult = processPageTest("AW21.Test.06.03.02-2Failed-09");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());

        processResult = processPageTest("AW21.Test.06.03.02-2Failed-10");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());

        processResult = processPageTest("AW21.Test.06.03.02-2Failed-11");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());

        processResult = processPageTest("AW21.Test.06.03.02-2Failed-12");
        assertEquals(TestSolution.FAILED,processResult.getValue());
        assertEquals("UnexplicitLinkOutOfContext",
                ((ProcessRemark)processResult.getRemarkSet().toArray()[0]).getMessageCode());

        processResult = processPageTest("AW21.Test.06.03.02-3NMI-01");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.03.02-3NMI-02");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.03.02-3NMI-03");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.03.02-3NMI-04");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.03.02-3NMI-05");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        processResult = processPageTest("AW21.Test.06.03.02-3NMI-06");
        assertEquals(TestSolution.NEED_MORE_INFO,processResult.getValue());
        assertNull(processResult.getRemarkSet());

        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.02-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.02-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.02-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.02-4NA-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.02-4NA-05").getValue());
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-2Failed-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-2Failed-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-2Failed-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-2Failed-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-2Failed-05").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-2Failed-06").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-2Failed-07").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-2Failed-08").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-3NMI-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-3NMI-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-3NMI-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-3NMI-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-3NMI-05").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-3NMI-06").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("AW21.Test.06.03.03-3NMI-07").getValue());
    }
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.FAILED,
                consolidate("AW21.Test.06.03.02-2Failed-09").getValue());
        assertEquals(TestSolution.FAILED,
                consolidate("AW21.Test.06.03.02-2Failed-10").getValue());
        assertEquals(TestSolution.FAILED,
                consolidate("AW21.Test.06.03.02-2Failed-11").getValue());
        assertEquals(TestSolution.FAILED,
                consolidate("AW21.Test.06.03.02-2Failed-12").getValue());
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.03.02-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.03.02-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.03.02-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.03.02-4NA-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("AW21.Test.06.03.02-4NA-05").getValue());
