 ...
 *
 * For more details about implementation, refer to <a href="https://gitlab.com/asqatasun/Asqatasun/-/blob/master/documentation/en/90_Rules/rgaa4.0/12.Navigation/Rule-12-5-2.md">rule 12.5.2 design page</a>.
...
public class Rgaa40Rule120502Test extends Rgaa40RuleImplementationTestCase {
    ...
    protected void setUpWebResourceMap() {
        getWebResourceMap().put("Rgaa40.Test.12.5.2-4NA-01",
                getWebResourceFactory().createPage(
                getTestcasesFilePath() + "rgaa40/Rgaa40Rule120502/Rgaa40.Test.12.5.2-3NMI-01.html"));

        Site site = getWebResourceFactory().createSite("file:Site-NotTested");
        getWebResourceMap().put("Rgaa40.Test.12.5.2-5NT-01", site);

        Page page = getWebResourceFactory().createPage(getTestcasesFilePath() +
                "rgaa40/Rgaa40Rule120502/Rgaa40.Test.12.5.2-3NMI-01.html");
        site.addChild(page);
        getWebResourceMap().put("Rgaa40.Test.12.5.2-5NT-01-page1",page);
    ...
    protected void setProcess() {
        ProcessResult pr = processPageTest("Rgaa40.Test.12.5.2-4NA-01");
        assertTrue(pr instanceof IndefiniteResult);
        assertEquals(getWebResourceMap().get("Rgaa40.Test.12.5.2-4NA-01"),pr.getSubject());
        assertEquals("mock-result", pr.getValue());
        
        process("Rgaa40.Test.12.5.2-5NT-01");
    ...
    protected void setConsolidate() {
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa40.Test.12.5.2-4NA-01").getValue());
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa40.Test.12.5.2-5NT-01").getValue());
    }
