...
public class Rgaa40Rule010204Test extends Rgaa40RuleImplementationTestCase {
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
        checkResultIsPassed(processPageTest("Rgaa40.Test.1.2.4-1Passed-01"), 4);

        //----------------------------------------------------------------------
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa40.Test.1.2.4-2Failed-01");
        checkResultIsFailed(processResult, 10, 10);
        ...
        checkRemarkIsPresent(
            ...
            new ImmutablePair<>(TITLE_ATTR, ABSENT_ATTRIBUTE_VALUE),
            new ImmutablePair<>(ARIA_LABEL_ATTR, ABSENT_ATTRIBUTE_VALUE),
            new ImmutablePair<>(COMPUTED_LINK_TITLE, "any text"));
        checkRemarkIsPresent(
            processResult,
            FAILED,
            DECORATIVE_ELEMENT_WITH_NOT_EMPTY_TEXTUAL_ALTERNATIVE_MSG,
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa40.Test.1.2.4-3NMI-01");
