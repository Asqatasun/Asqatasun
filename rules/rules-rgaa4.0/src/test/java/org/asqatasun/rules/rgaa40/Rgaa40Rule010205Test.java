...
public class Rgaa40Rule010205Test extends Rgaa40RuleImplementationTestCase {
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
        checkResultIsPassed(processPageTest("Rgaa40.Test.1.2.5-1Passed-01"), 2);
        ...
        checkRemarkIsPresent(
            ...
            CANVAS_ELEMENT,
            5,
            new ImmutablePair<>(TEXT_ELEMENT2, "Textual alternative"),
            new ImmutablePair<>(ARIA_LABEL_ATTR, ABSENT_ATTRIBUTE_VALUE),
            new ImmutablePair<>(COMPUTED_LINK_TITLE, "Textual alternative"));

        //----------------------------------------------------------------------
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa40.Test.1.2.5-3NMI-01");
