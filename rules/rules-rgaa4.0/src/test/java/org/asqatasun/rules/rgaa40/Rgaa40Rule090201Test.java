 ...
 *
 * For more details about implementation, refer to <a href="https://gitlab.com/asqatasun/Asqatasun/-/blob/v5/documentation/en/90_Rules/rgaa4.0/09.Structure_of_information/Rule-9-2-1.md">rule 9.2.1 design page</a>.
...
//        addWebResource("Rgaa40.Test.9.2.1-1Passed-01");
...
//        addWebResource("Rgaa40.Test.9.2.1-4NA-01");
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsPassed(processPageTest("Rgaa40.Test.9.2.1-1Passed-01"), 1);
...
//                new ImmutablePair("#ExtractedAttributeAsEvidence", "#ExtractedAttributeValue"));
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa40.Test.9.2.1-3NMI-01");
...
//        checkResultIsNotApplicable(processPageTest("Rgaa40.Test.9.2.1-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
            consolidate("Rgaa40.Test.9.2.1-3NMI-01").getValue());
    }
