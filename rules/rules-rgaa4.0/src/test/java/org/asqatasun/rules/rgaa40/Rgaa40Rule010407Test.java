 ...
 *
 * For more details about implementation, refer to <a href="https://gitlab.com/asqatasun/Asqatasun/-/blob/v5/documentation/en/90_Rules/rgaa4.0/01.Images/Rule-1-4-7.md">rule 1.4.7 design page</a>.
...
public class Rgaa40Rule010407Test extends Rgaa40RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa40.Rgaa40Rule010407");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa40.Test.1.4.7-1Passed-01");
//        addWebResource("Rgaa40.Test.1.4.7-2Failed-01");
...
//        addWebResource("Rgaa40.Test.1.4.7-4NA-01");
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsPassed(processPageTest("Rgaa40.Test.1.4.7-1Passed-01"), 1);

        //----------------------------------------------------------------------
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
//        ProcessResult processResult = processPageTest("Rgaa40.Test.1.4.7-2Failed-01");
...
//        checkResultIsNotApplicable(processPageTest("Rgaa40.Test.1.4.7-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa40.Test.1.4.7-3NMI-01").getValue());
    }
