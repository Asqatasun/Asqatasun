...
/**
 * Unit test class for the implementation of the rule 11.2.2 of the referential RGAA 4.0
 *
 * @author
 */
public class Rgaa40Rule110202Test extends Rgaa40RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa40.Rgaa40Rule110202");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa40.Test.11.2.2-1Passed-01");
//        addWebResource("Rgaa40.Test.11.2.2-2Failed-01");
...
//        addWebResource("Rgaa40.Test.11.2.2-4NA-01");
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsPassed(processPageTest("Rgaa40.Test.11.2.2-1Passed-01"), 1);

        //----------------------------------------------------------------------
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
//        ProcessResult processResult = processPageTest("Rgaa40.Test.11.2.2-2Failed-01");
...
//        checkResultIsNotApplicable(processPageTest("Rgaa40.Test.11.2.2-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa40.Test.11.2.2-3NMI-01").getValue());
}
