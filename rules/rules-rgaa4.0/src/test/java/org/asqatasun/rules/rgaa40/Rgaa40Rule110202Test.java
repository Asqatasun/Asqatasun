 ...
 *
 * For more details about implementation, refer to <a href="https://gitlab.com/asqatasun/Asqatasun/-/blob/master/documentation/en/90_Rules/rgaa4.0/11.Forms/Rule-11-2-2.md">rule 11.2.2 design page</a>.
...
public class Rgaa40Rule110202Test extends Rgaa40RuleImplementationTestCase {
    ...
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa40.Test.11.2.2-3NMI-01");
        addWebResource("Rgaa40.Test.11.2.2-3NMI-02");
        addWebResource("Rgaa40.Test.11.2.2-3NMI-03");
        addWebResource("Rgaa40.Test.11.2.2-3NMI-04");
        addWebResource("Rgaa40.Test.11.2.2-3NMI-05");
        addWebResource("Rgaa40.Test.11.2.2-3NMI-06");
        addWebResource("Rgaa40.Test.11.2.2-3NMI-07");
        addWebResource("Rgaa40.Test.11.2.2-3NMI-08");

        addWebResource("Rgaa40.Test.11.2.2-4NA-01");
        addWebResource("Rgaa40.Test.11.2.2-4NA-02");
        addWebResource("Rgaa40.Test.11.2.2-4NA-03");
        addWebResource("Rgaa40.Test.11.2.2-4NA-04");
        addWebResource("Rgaa40.Test.11.2.2-4NA-05");
        addWebResource("Rgaa40.Test.11.2.2-4NA-06");
        addWebResource("Rgaa40.Test.11.2.2-4NA-07");
        addWebResource("Rgaa40.Test.11.2.2-4NA-08");
    }
    ...
    protected void setProcess() {
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(TITLE_ATTR, "title for input without type attribute (implicit text)"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            HtmlElementStore.INPUT_ELEMENT,
            2,
            new ImmutablePair(TITLE_ATTR, "title for input with type equal to text"));
        ...
        for (Map.Entry item : mapTypeAttribute.entrySet()) {
            ...
            checkRemarkIsPresent(
                ...
                HtmlElementStore.INPUT_ELEMENT,
                position,
                new ImmutablePair(TITLE_ATTR, "title for input with type equal to " + item.getValue()));
        }
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(TITLE_ATTR, "title value for TEXTAREA"));
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(TITLE_ATTR, "title value for SELECT"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            ...
            2,
            new ImmutablePair(TITLE_ATTR, "title value for OPTGROUP"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            ...
            3,
            new ImmutablePair(TITLE_ATTR, "title value for OPTION"));
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(TITLE_ATTR, "title value for DATALIST"));
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(TITLE_ATTR, "title value for PROGRESS"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            ...
            2,
            new ImmutablePair(TITLE_ATTR, "title value for OUTPUT"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            ...
            3,
            new ImmutablePair(TITLE_ATTR, "title value for METER"));
        ...
        for (Map.Entry item : mapRoleAttribute.entrySet()) {
            ...
            checkRemarkIsPresent(
                ...
                position,
                new ImmutablePair(TITLE_ATTR, "title value for ROLE " + item.getValue()));
        }
        ...
        checkRemarkIsPresent(
            ...
            HtmlElementStore.INPUT_ELEMENT,
            1,
            new ImmutablePair(TITLE_ATTR, "title for input without parent form tag"));
