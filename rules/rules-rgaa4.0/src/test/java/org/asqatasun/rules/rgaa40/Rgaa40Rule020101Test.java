...
/**
 * Unit test class for the implementation of the rule 2.1.1 of the referential RGAA 4.0
 *
 * @author
 */
...
//        addWebResource("Rgaa40.Test.2.1.1-2Failed-01");
        addWebResource("Rgaa40.Test.2.1.1-3NMI-01");
...
//                new ImmutablePair("#ExtractedAttributeAsEvidence", "#ExtractedAttributeValue"));
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa40.Test.2.1.1-3NMI-01");
...
//        checkResultIsNotApplicable(processPageTest("Rgaa40.Test.2.1.1-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa40.Test.2.1.1-3NMI-01").getValue());
}
