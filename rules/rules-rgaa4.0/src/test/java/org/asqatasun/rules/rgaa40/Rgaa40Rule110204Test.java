...
/**
 * Unit test class for implementation of rule 11.2.4 (referential RGAA 4.0)
 *
 * For more details about implementation, refer to <a href="https://gitlab.com/asqatasun/Asqatasun/-/blob/master/documentation/en/90_Rules/rgaa4.0/11.Forms/Rule-11-2-4.md">rule 11.2.4 design page</a>.
 * @see <a href="https://www.numerique.gouv.fr/publications/rgaa-accessibilite/methode/criteres/#test-11-2-4">11.2.4 rule specification</a>
 */
public class Rgaa40Rule110204Test extends Rgaa40RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa40Rule110204Test(String testName) {
        super(testName);
    }

    @Override
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.asqatasun.rules.rgaa40.Rgaa40Rule110204");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa40.Test.11.2.4-3NMI-01");
        addWebResource("Rgaa40.Test.11.2.4-3NMI-02");
        addWebResource("Rgaa40.Test.11.2.4-3NMI-03");
        addWebResource("Rgaa40.Test.11.2.4-3NMI-04");
        addWebResource("Rgaa40.Test.11.2.4-3NMI-05");
        addWebResource("Rgaa40.Test.11.2.4-3NMI-06");
        addWebResource("Rgaa40.Test.11.2.4-3NMI-07");
        addWebResource("Rgaa40.Test.11.2.4-3NMI-08");

        addWebResource("Rgaa40.Test.11.2.4-4NA-01");
        addWebResource("Rgaa40.Test.11.2.4-4NA-02");
        addWebResource("Rgaa40.Test.11.2.4-4NA-03");
        addWebResource("Rgaa40.Test.11.2.4-4NA-04");
        addWebResource("Rgaa40.Test.11.2.4-4NA-05");
        addWebResource("Rgaa40.Test.11.2.4-4NA-06");
        addWebResource("Rgaa40.Test.11.2.4-4NA-07");
        addWebResource("Rgaa40.Test.11.2.4-4NA-08");
    }
    ...
    protected void setProcess() {
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-for-input-without-type-attribute"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            HtmlElementStore.INPUT_ELEMENT,
            2,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-for-input-with-type-equal-to-text"));
        ...
        for (Map.Entry item : mapTypeAttribute.entrySet()) {
            ...
            checkRemarkIsPresent(
                ...
                HtmlElementStore.INPUT_ELEMENT,
                position,
                new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-for-input-with-type-equal-to-" + item.getValue()));
        }
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-id-for-TEXTAREA"));
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-id-for-SELECT"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            ...
            2,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-id-for-OPTGROUP"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            ...
            3,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-id-for-OPTION"));
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-id-for-DATALIST"));
        ...
        checkRemarkIsPresent(
            ...
            1,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-id-for-PROGRESS"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            ...
            2,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-id-for-OUTPUT"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            ...
            3,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-id-for-METER"));
        ...
        for (Map.Entry item : mapRoleAttribute.entrySet()) {
            ...
            checkRemarkIsPresent(
                ...
                position,
                new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-id-for-ROLE-" + item.getValue()));
        }
        ...
        checkRemarkIsPresent(
            ...
            HtmlElementStore.INPUT_ELEMENT,
            1,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby-for-input-without-parent-form-tag"));
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
            RemarkMessageStore.MANUAL_CHECK_ON_ELEMENTS_MSG,
            HtmlElementStore.INPUT_ELEMENT,
            1,
            new ImmutablePair(ARIA_LABELLEDBY_ATTR, "aria-labelledby1 aria-labelledby2 aria-labelledby-for-input-without-parent-form-tag"));
