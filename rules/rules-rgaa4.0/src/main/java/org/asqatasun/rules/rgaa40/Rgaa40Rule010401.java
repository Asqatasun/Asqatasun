...
/**
 * Implementation of rule 1.4.1 (referential RGAA 4.0)
 *
 * For more details about implementation, refer to <a href="https://doc.asqatasun.org/v5/en/Business-rules/RGAA-v4/01.Images/Rule-1-4-1/">rule 1.4.1 design page</a>.
 ...
 */
public class Rgaa40Rule010401 extends AbstractDetectionPageRuleImplementation {

    /**
     * Default constructor
     */
    public Rgaa40Rule010401 () {
        super(
            new ElementWithAccessibleNameSelector(new CaptchaElementSelector(new SimpleElementSelector(BASIC_IMG_CSS_LIKE_QUERY))),
