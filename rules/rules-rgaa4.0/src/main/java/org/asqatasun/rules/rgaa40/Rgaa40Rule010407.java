...
/**
 * Implementation of rule 1.4.7 (referential RGAA 4.0)
 *
 * For more details about implementation, refer to <a href="https://doc.asqatasun.org/v5/en/Business-rules/RGAA-v4/01.Images/Rule-1-4-7/">rule 1.4.7 design page</a>.
 ...
 */
public class Rgaa40Rule010407 extends AbstractDetectionPageRuleImplementation {

    /**
     * Default constructor
     */
    public Rgaa40Rule010407 () {
        super(
            new ElementWithAccessibleNameSelector(new CaptchaElementSelector(new SimpleElementSelector(CANVAS_NOT_IN_LINK_CSS_LIKE_QUERY))),
