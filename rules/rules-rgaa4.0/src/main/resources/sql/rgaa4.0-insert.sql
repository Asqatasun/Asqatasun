...
-- Set Rule_Design_Url
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('01.images/rule-',                       SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-1-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('02.frames/rule-',                       SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-2-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('03.colours/rule-',                      SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-3-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('04.multimedia/rule-',                   SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-4-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('05.tables/rule-',                       SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-5-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('06.links/rule-',                        SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-6-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('07.scripts/rule-',                      SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-7-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('08.mandatory_elements/rule-',           SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-8-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('09.structure_of_information/rule-',     SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-9-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('10.presentation_of_information/rule-',  SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-10-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('11.forms/rule-',                        SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-11-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('12.navigation/rule-',                   SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-12-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('13.consultation/rule-',                 SUBSTRING(`Cd_Test`,8), '/') WHERE `Cd_Test` LIKE 'Rgaa40-13-%';
UPDATE `TEST` SET `Rule_Design_Url` = CONCAT('https://doc.asqatasun.org/v5/en/business-rules/rgaa-v4/', `Rule_Design_Url`)     WHERE `Cd_Test` LIKE 'Rgaa40-%';
