...
/**
 * Implementation of the rule 10.7.1 of the referential RGAA 3.2016
 * <br/>
 * For more details about the implementation, refer to <a href="http://doc.asqatasun.org/en/90_Rules/rgaa3.2016/10.Presentation_of_information/Rule-10-7-1.html">the rule 10.7.1 design page.</a>
 * @see <a href="http://references.modernisation.gouv.fr/rgaa-accessibilite/2016/criteres.html#test-10-7-1">10.7.1 rule specification</a>
 *
 * @author jkowalczyk
 */

public class Rgaa32016Rule100701 extends AbstractPageRuleFromPreProcessImplementation {
     ...
     * Default constructor
     */
    public Rgaa32016Rule100701  () {
        super(
                new ElementPresenceChecker(
                    // if some elements are found
                    new ImmutablePair(TestSolution.NEED_MORE_INFO, INVISIBLE_OUTLINE_ON_FOCUS_MSG),
                    // if no found element
