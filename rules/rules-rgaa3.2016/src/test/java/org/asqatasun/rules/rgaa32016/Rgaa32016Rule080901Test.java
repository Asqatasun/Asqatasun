...
public class Rgaa32016Rule080901Test extends Rgaa32016RuleImplementationTestCase {
    ...
    protected void setUpWebResourceMap() {
        ...
        addWebResource("Rgaa32016.Test.08.09.01-3NMI-08");
        addWebResource("Rgaa32016.Test.08.09.01-3NMI-09");
    }
    ...
    protected void setProcess() {
        ...
        //---------------------------3NMI-08------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32016.Test.08.09.01-3NMI-08");
        checkResultIsPreQualified(processResult, 17, 1);
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
        ...
        //---------------------------3NMI-09------------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32016.Test.08.09.01-3NMI-09");
        checkResultIsPreQualified(processResult, 17, 1);
        checkRemarkIsPresent(
            processResult,
            TestSolution.NEED_MORE_INFO,
