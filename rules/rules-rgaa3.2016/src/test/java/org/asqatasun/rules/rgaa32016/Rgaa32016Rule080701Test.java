...
/**
 * Unit test class for the implementation of the rule 8.7.1 of the referential RGAA 3.2016
 *
 * @author jkowalczyk
 */
public class Rgaa32016Rule080701Test extends Rgaa32016RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa32016Rule080701Test (String testName){
        super(testName);
    }

    @Override
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.asqatasun.rules.rgaa32016.Rgaa32016Rule080701");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa32016.Test.08.07.01-1Passed-01");
        addWebResource("Rgaa32016.Test.08.07.01-1Passed-02");
        addWebResource("Rgaa32016.Test.08.07.01-1Passed-03");
        addWebResource("Rgaa32016.Test.08.07.01-1Passed-04");
        addWebResource("Rgaa32016.Test.08.07.01-1Passed-05");
        addWebResource("Rgaa32016.Test.08.07.01-2Failed-01");
        addWebResource("Rgaa32016.Test.08.07.01-2Failed-02");
        addWebResource("Rgaa32016.Test.08.07.01-2Failed-03");
        addWebResource("Rgaa32016.Test.08.07.01-2Failed-04");
        addWebResource("Rgaa32016.Test.08.07.01-2Failed-05");
        addWebResource("Rgaa32016.Test.08.07.01-2Failed-06");
        addWebResource("Rgaa32016.Test.08.07.01-2Failed-07");
        addWebResource("Rgaa32016.Test.08.07.01-3NMI-01");
        addWebResource("Rgaa32016.Test.08.07.01-3NMI-02");
        addWebResource("Rgaa32016.Test.08.07.01-3NMI-03");
        addWebResource("Rgaa32016.Test.08.07.01-3NMI-04");
        addWebResource("Rgaa32016.Test.08.07.01-4NA-01");
        addWebResource("Rgaa32016.Test.08.07.01-4NA-02");
        addWebResource("Rgaa32016.Test.08.07.01-4NA-03");
        addWebResource("Rgaa32016.Test.08.07.01-4NA-04");
