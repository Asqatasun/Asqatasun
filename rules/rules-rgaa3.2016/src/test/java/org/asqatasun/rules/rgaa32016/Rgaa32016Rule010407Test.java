...
/**
 * Unit test class for the implementation of the rule 1.4.7 of the referential RGAA 3.2016
 *
 * @author
 */
public class Rgaa32016Rule010407Test extends Rgaa32016RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa32016Rule010407Test (String testName){
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa32016.Rgaa32016Rule010407");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa32016.Test.1.4.7-1Passed-01");
//        addWebResource("Rgaa32016.Test.1.4.7-2Failed-01");
        addWebResource("Rgaa32016.Test.1.4.7-3NMI-01");
//        addWebResource("Rgaa32016.Test.1.4.7-4NA-01");
    }
...
//        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.1.4.7-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32016.Test.1.4.7-3NMI-01").getValue());
}
