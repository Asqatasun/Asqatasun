...
//        addWebResource("Rgaa32016.Test.1.1.3-2Failed-01");
        addWebResource("Rgaa32016.Test.1.1.3-3NMI-01");
...
//                new ImmutablePair("#ExtractedAttributeAsEvidence", "#ExtractedAttributeValue"));
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa32016.Test.1.1.3-3NMI-01");
...
//        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.1.1.3-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32016.Test.1.1.3-3NMI-01").getValue());
}
