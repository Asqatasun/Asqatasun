...
/**
 * Unit test class for the implementation of the rule 13.12.1 of the referential RGAA 3.2016
 *
 * @author
 */
public class Rgaa32016Rule131201Test extends Rgaa32016RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa32016Rule131201Test (String testName){
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa32016.Rgaa32016Rule131201");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa32016.Test.13.12.1-1Passed-01");
//        addWebResource("Rgaa32016.Test.13.12.1-2Failed-01");
        addWebResource("Rgaa32016.Test.13.12.1-3NMI-01");
//        addWebResource("Rgaa32016.Test.13.12.1-4NA-01");
    }
...
//        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.13.12.1-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32016.Test.13.12.1-3NMI-01").getValue());
}
