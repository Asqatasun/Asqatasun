 ...
 */
package org.asqatasun.rules.rgaa32016.test;
 ...
 * @author
 */
public abstract class Rgaa32016RuleImplementationTestCase extends AbstractRuleImplementationTestCase {
    ...
    public Rgaa32016RuleImplementationTestCase(String testName) {
        super(testName, INPUT_FILE_DATA_NAME, TESTCASE_FILE_PATH);
    }
    
    public Rgaa32016RuleImplementationTestCase(String testName, String inputFileDataName) {
