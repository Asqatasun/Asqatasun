...
public class Rgaa32016Rule110803Test extends Rgaa32016RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa32016.Rgaa32016Rule110803");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa32016.Test.11.8.3-1Passed-01");
//        addWebResource("Rgaa32016.Test.11.8.3-2Failed-01");
        addWebResource("Rgaa32016.Test.11.8.3-3NMI-01");
//        addWebResource("Rgaa32016.Test.11.8.3-4NA-01");
    }
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsPassed(processPageTest("Rgaa32016.Test.11.8.3-1Passed-01"), 1);

        //----------------------------------------------------------------------
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
//        ProcessResult processResult = processPageTest("Rgaa32016.Test.11.8.3-2Failed-01");
...
//                new ImmutablePair("#ExtractedAttributeAsEvidence", "#ExtractedAttributeValue"));
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa32016.Test.11.8.3-3NMI-01");
...
//                new ImmutablePair("#ExtractedAttributeAsEvidence", "#ExtractedAttributeValue"));
        ...
        //------------------------------4NA-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.11.8.3-4NA-01"));
    }
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32016.Test.11.8.3-3NMI-01").getValue());
}
