...
public class Rgaa32016Rule010706Test extends Rgaa32016RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa32016.Rgaa32016Rule010706");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa32016.Test.1.7.6-1Passed-01");
//        addWebResource("Rgaa32016.Test.1.7.6-2Failed-01");
...
//        addWebResource("Rgaa32016.Test.1.7.6-4NA-01");
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsPassed(processPageTest("Rgaa32016.Test.1.7.6-1Passed-01"), 1);

        //----------------------------------------------------------------------
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
//        ProcessResult processResult = processPageTest("Rgaa32016.Test.1.7.6-2Failed-01");
...
//        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.1.7.6-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32016.Test.1.7.6-3NMI-01").getValue());
}
