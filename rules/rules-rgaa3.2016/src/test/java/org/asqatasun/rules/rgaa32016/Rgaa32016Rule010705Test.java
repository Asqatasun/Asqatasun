...
public class Rgaa32016Rule010705Test extends Rgaa32016RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.asqatasun.rules.rgaa32016.Rgaa32016Rule010705");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa32016.Test.01.07.04-3NMI-01",
                createParameter("Rules", INFORMATIVE_IMAGE_MARKER, "informative-image"));
        addWebResource("Rgaa32016.Test.01.07.04-3NMI-02");
        addWebResource("Rgaa32016.Test.01.07.04-4NA-01");
        addWebResource("Rgaa32016.Test.01.07.04-4NA-02");
        addWebResource("Rgaa32016.Test.01.07.04-4NA-03");
        addWebResource("Rgaa32016.Test.01.07.04-4NA-04",
