...
/**
 * Unit test class for the implementation of the rule 3.2.3 of the referential RGAA 3.2016
 *
 * @author
 */
public class Rgaa32016Rule030203Test extends Rgaa32016RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa32016Rule030203Test (String testName){
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa32016.Rgaa32016Rule030203");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa32016.Test.3.2.3-1Passed-01");
//        addWebResource("Rgaa32016.Test.3.2.3-2Failed-01");
        addWebResource("Rgaa32016.Test.3.2.3-3NMI-01");
//        addWebResource("Rgaa32016.Test.3.2.3-4NA-01");
    }
