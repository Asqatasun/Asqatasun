...
//        addWebResource("Rgaa32016.Test.4.22.2-1Passed-01");
//        addWebResource("Rgaa32016.Test.4.22.2-2Failed-01");
...
//        addWebResource("Rgaa32016.Test.4.22.2-4NA-01");
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsPassed(processPageTest("Rgaa32016.Test.4.22.2-1Passed-01"), 1);

        //----------------------------------------------------------------------
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
//        ProcessResult processResult = processPageTest("Rgaa32016.Test.4.22.2-2Failed-01");
...
//        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.4.22.2-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32016.Test.4.22.2-3NMI-01").getValue());
}
