...
/**
 * Unit test class for the implementation of the rule 9.3.2 of the referential RGAA 3.2016
 *
 * @author
 */
public class Rgaa32016Rule090302Test extends Rgaa32016RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa32016Rule090302Test (String testName){
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa32016.Rgaa32016Rule090302");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa32016.Test.9.3.2-1Passed-01");
//        addWebResource("Rgaa32016.Test.9.3.2-2Failed-01");
        addWebResource("Rgaa32016.Test.9.3.2-3NMI-01");
//        addWebResource("Rgaa32016.Test.9.3.2-4NA-01");
    }
...
//        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.9.3.2-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32016.Test.9.3.2-3NMI-01").getValue());
}
