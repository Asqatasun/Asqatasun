...
/**
 * Unit test class for the implementation of the rule 6.4.1 of the referential RGAA 3.2016
 *
 * @author jkowalczyk
 */
public class Rgaa32016Rule060401Test extends Rgaa32016RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa32016Rule060401Test (String testName){
        super(testName);
    }

    @Override
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.asqatasun.rules.rgaa32016.Rgaa32016Rule060401");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa32016.Test.06.04.01-1Passed-01");
        addWebResource("Rgaa32016.Test.06.04.01-1Passed-02");
        addWebResource("Rgaa32016.Test.06.04.01-2Failed-01");
        addWebResource("Rgaa32016.Test.06.04.01-2Failed-02");
        addWebResource("Rgaa32016.Test.06.04.01-2Failed-03");
        addWebResource("Rgaa32016.Test.06.04.01-3NMI-01");
        addWebResource("Rgaa32016.Test.06.04.01-3NMI-02");
        addWebResource("Rgaa32016.Test.06.04.01-3NMI-03");
        addWebResource("Rgaa32016.Test.06.04.01-4NA-01");
        addWebResource("Rgaa32016.Test.06.04.01-4NA-02");
        addWebResource("Rgaa32016.Test.06.04.01-4NA-03");
        addWebResource("Rgaa32016.Test.06.04.01-4NA-04");
        addWebResource("Rgaa32016.Test.06.04.01-4NA-05");
        addWebResource("Rgaa32016.Test.06.04.01-4NA-06");
    ...
    protected void setProcess() {
        ProcessResult processResult =
                processPageTest("Rgaa32016.Test.06.04.01-1Passed-01");
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Rgaa32016.Test.06.04.01-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Rgaa32016.Test.06.04.01-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Rgaa32016.Test.06.04.01-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Rgaa32016.Test.06.04.01-4NA-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Rgaa32016.Test.06.04.01-4NA-05").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                processPageTest("Rgaa32016.Test.06.04.01-4NA-06").getValue());
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32016.Test.06.04.01-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32016.Test.06.04.01-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32016.Test.06.04.01-4NA-03").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32016.Test.06.04.01-4NA-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32016.Test.06.04.01-4NA-05").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32016.Test.06.04.01-4NA-06").getValue());
