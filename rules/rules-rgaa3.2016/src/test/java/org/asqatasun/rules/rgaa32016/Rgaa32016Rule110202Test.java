...
/**
 * Unit test class for the implementation of the rule 11.2.2 of the referential RGAA 3.2016
 *
 * @author jkowalczyk
 */
public class Rgaa32016Rule110202Test extends Rgaa32016RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa32016Rule110202Test (String testName){
        super(testName);
    }

    @Override
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.asqatasun.rules.rgaa32016.Rgaa32016Rule110202");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa32016.Test.11.02.02-3NMI-01");
        addWebResource("Rgaa32016.Test.11.02.02-3NMI-02");
        addWebResource("Rgaa32016.Test.11.02.02-3NMI-03");
        addWebResource("Rgaa32016.Test.11.02.02-3NMI-04");
        addWebResource("Rgaa32016.Test.11.02.02-3NMI-05");
        addWebResource("Rgaa32016.Test.11.02.02-3NMI-06");
        addWebResource("Rgaa32016.Test.11.02.02-3NMI-07");
        addWebResource("Rgaa32016.Test.11.02.02-4NA-01");
        addWebResource("Rgaa32016.Test.11.02.02-4NA-02");
        addWebResource("Rgaa32016.Test.11.02.02-4NA-03");
        addWebResource("Rgaa32016.Test.11.02.02-4NA-04");
        addWebResource("Rgaa32016.Test.11.02.02-4NA-05");
        addWebResource("Rgaa32016.Test.11.02.02-4NA-06");
        addWebResource("Rgaa32016.Test.11.02.02-4NA-07");
