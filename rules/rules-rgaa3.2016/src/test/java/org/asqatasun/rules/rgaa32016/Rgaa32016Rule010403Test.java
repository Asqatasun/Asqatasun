...
public class Rgaa32016Rule010403Test extends Rgaa32016RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.asqatasun.rules.rgaa32016.Rgaa32016Rule010403");
    }

    @Override
    protected void setUpWebResourceMap() {
//        addWebResource("Rgaa32016.Test.1.4.3-1Passed-01");
//        addWebResource("Rgaa32016.Test.1.4.3-2Failed-01");
        addWebResource("Rgaa32016.Test.1.4.3-3NMI-01");
//        addWebResource("Rgaa32016.Test.1.4.3-4NA-01");
    }
...
//        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.1.4.3-4NA-01"));
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa32016.Test.1.4.3-3NMI-01").getValue());
}
