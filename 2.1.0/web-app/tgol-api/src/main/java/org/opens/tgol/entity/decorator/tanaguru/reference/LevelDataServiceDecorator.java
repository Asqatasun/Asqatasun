...
/**
 * This interface decorates the LevelDataService interface defined in
 * the tanaguru API and adds more primitives.
 *
 * @author jkowalczyk
 */
public interface LevelDataServiceDecorator extends LevelDataService {
     ...
     *      the level instance
     */
    Level getLevelByCode(String code);
